...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudPubSubLogging.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new GoogleCloudPubSubLogging.InlineObject();
      //expect(instance).to.be.a(GoogleCloudPubSubLogging.InlineObject);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new GoogleCloudPubSubLogging.InlineObject();
