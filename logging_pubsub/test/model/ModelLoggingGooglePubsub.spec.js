...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudPubSubLogging.ModelLoggingGooglePubsub();
  });
  ...
  describe('ModelLoggingGooglePubsub', function() {
    it('should create an instance of ModelLoggingGooglePubsub', function() {
      // uncomment below and update the code to test ModelLoggingGooglePubsub
      //var instane = new GoogleCloudPubSubLogging.ModelLoggingGooglePubsub();
      //expect(instance).to.be.a(GoogleCloudPubSubLogging.ModelLoggingGooglePubsub);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new GoogleCloudPubSubLogging.ModelLoggingGooglePubsub();
