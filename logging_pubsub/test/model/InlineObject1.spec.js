...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GoogleCloudPubSubLogging.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new GoogleCloudPubSubLogging.InlineObject1();
      //expect(instance).to.be.a(GoogleCloudPubSubLogging.InlineObject1);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new GoogleCloudPubSubLogging.InlineObject1();
