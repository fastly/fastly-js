...
class ApiClient {
    constructor() {
        ...
        this.authentications = {
            'edge_check': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'session_or_token': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'token': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'token_billing': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'token_engineer': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'token_superuser': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'token_tls': {type: 'apiKey', 'in': 'header', name: 'Fastly-Key'},
            'username_and_password': {type: 'basic'}
        }

        
        this.defaultHeaders = {
            'User-Agent': 'fastly-js/1.0.0'
        };
