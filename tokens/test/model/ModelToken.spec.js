...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tokens.ModelToken();
  });
  ...
  describe('ModelToken', function() {
    it('should create an instance of ModelToken', function() {
      // uncomment below and update the code to test ModelToken
      //var instane = new Tokens.ModelToken();
      //expect(instance).to.be.a(Tokens.ModelToken);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Tokens.ModelToken();
