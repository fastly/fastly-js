...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tokens.GenericTokenError();
  });
  ...
  describe('GenericTokenError', function() {
    it('should create an instance of GenericTokenError', function() {
      // uncomment below and update the code to test GenericTokenError
      //var instane = new Tokens.GenericTokenError();
      //expect(instance).to.be.a(Tokens.GenericTokenError);
    });

    it('should have the property msg (base name: "msg")', function() {
      // uncomment below and update the code to test the property msg
      //var instance = new Tokens.GenericTokenError();
