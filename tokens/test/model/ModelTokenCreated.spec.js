...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tokens.ModelTokenCreated();
  });
  ...
  describe('ModelTokenCreated', function() {
    it('should create an instance of ModelTokenCreated', function() {
      // uncomment below and update the code to test ModelTokenCreated
      //var instane = new Tokens.ModelTokenCreated();
      //expect(instance).to.be.a(Tokens.ModelTokenCreated);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new Tokens.ModelTokenCreated();
