...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Tokens.InlineResponse400();
  });
  ...
  describe('InlineResponse400', function() {
    it('should create an instance of InlineResponse400', function() {
      ...
      //var instane = new Tokens.InlineResponse400();
      //expect(instance).to.be.a(Tokens.InlineResponse400);
    });

    it('should have the property code (base name: "code")', function() {
      // uncomment below and update the code to test the property code
      //var instance = new Tokens.InlineResponse400();
