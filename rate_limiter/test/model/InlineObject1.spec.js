...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RateLimiter.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new RateLimiter.InlineObject1();
      //expect(instance).to.be.a(RateLimiter.InlineObject1);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new RateLimiter.InlineObject1();
