...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RateLimiter.ModelRateLimiter();
  });
  ...
  describe('ModelRateLimiter', function() {
    it('should create an instance of ModelRateLimiter', function() {
      // uncomment below and update the code to test ModelRateLimiter
      //var instane = new RateLimiter.ModelRateLimiter();
      //expect(instance).to.be.a(RateLimiter.ModelRateLimiter);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new RateLimiter.ModelRateLimiter();
