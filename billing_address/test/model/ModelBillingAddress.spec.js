...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BillingAddress.ModelBillingAddress();
  });
  ...
  describe('ModelBillingAddress', function() {
    it('should create an instance of ModelBillingAddress', function() {
      // uncomment below and update the code to test ModelBillingAddress
      //var instane = new BillingAddress.ModelBillingAddress();
      //expect(instance).to.be.a(BillingAddress.ModelBillingAddress);
    });
    ...
    it('should have the property address1 (base name: "address_1")', function() {
      ...
      //var instance = new BillingAddress.ModelBillingAddress();
