...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Loggly.ModelLoggingLoggly();
  });
  ...
  describe('ModelLoggingLoggly', function() {
    it('should create an instance of ModelLoggingLoggly', function() {
      // uncomment below and update the code to test ModelLoggingLoggly
      //var instane = new Loggly.ModelLoggingLoggly();
      //expect(instance).to.be.a(Loggly.ModelLoggingLoggly);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Loggly.ModelLoggingLoggly();
