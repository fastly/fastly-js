...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sumologic.ModelLoggingSumologic();
  });
  ...
  describe('ModelLoggingSumologic', function() {
    it('should create an instance of ModelLoggingSumologic', function() {
      // uncomment below and update the code to test ModelLoggingSumologic
      //var instane = new Sumologic.ModelLoggingSumologic();
      //expect(instance).to.be.a(Sumologic.ModelLoggingSumologic);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Sumologic.ModelLoggingSumologic();
