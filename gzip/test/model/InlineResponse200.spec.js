...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Gzip.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instane = new Gzip.InlineResponse200();
      //expect(instance).to.be.a(Gzip.InlineResponse200);
    });

    it('should have the property serviceId (base name: "service_id")', function() {
      // uncomment below and update the code to test the property serviceId
      //var instance = new Gzip.InlineResponse200();
