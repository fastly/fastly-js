...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BigQuery.ModelLoggingBigquery();
  });
  ...
  describe('ModelLoggingBigquery', function() {
    it('should create an instance of ModelLoggingBigquery', function() {
      // uncomment below and update the code to test ModelLoggingBigquery
      //var instane = new BigQuery.ModelLoggingBigquery();
      //expect(instance).to.be.a(BigQuery.ModelLoggingBigquery);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new BigQuery.ModelLoggingBigquery();
    ...
    it('should have the property templateSuffix (base name: "template_suffix")', function() {
