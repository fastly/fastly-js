...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Package.ModelPackage();
  });
  ...
  describe('ModelPackage', function() {
    it('should create an instance of ModelPackage', function() {
      ...
      //var instane = new Package.ModelPackage();
      //expect(instance).to.be.a(Package.ModelPackage);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Package.ModelPackage();
