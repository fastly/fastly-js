...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OriginInsights.ModelEntry();
  });
  ...
  describe('ModelEntry', function() {
    it('should create an instance of ModelEntry', function() {
      ...
      //var instane = new OriginInsights.ModelEntry();
      //expect(instance).to.be.a(OriginInsights.ModelEntry);
    });
    ...
    it('should have the property recorded (base name: "recorded")', function() {
      ...
      //var instance = new OriginInsights.ModelEntry();
