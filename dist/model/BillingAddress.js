...
var _BillingAddressData = _interopRequireDefault(require("./BillingAddressData"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BillingAddressData["default"].constructFromObject(data['data']);
        }
      }
