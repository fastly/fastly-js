 ...
 * @module model/CustomerCustomerIdBillingAddressData
 * @version 3.0.0-alpha1
 */
var CustomerCustomerIdBillingAddressData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CustomerCustomerIdBillingAddressData</code>.
   * @alias module:model/CustomerCustomerIdBillingAddressData
   */
  function CustomerCustomerIdBillingAddressData() {
    _classCallCheck(this, CustomerCustomerIdBillingAddressData);
  ...
  _createClass(CustomerCustomerIdBillingAddressData, null, [{
    key: "initialize",
     ...
     * @param {module:model/CustomerCustomerIdBillingAddressData} obj Optional instance to populate.
     * @return {module:model/CustomerCustomerIdBillingAddressData} The populated <code>CustomerCustomerIdBillingAddressData</code> instance.
     */
