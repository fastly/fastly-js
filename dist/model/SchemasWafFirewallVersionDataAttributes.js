 ...
 * @module model/SchemasWafFirewallVersionDataAttributes
 * @version 3.0.0-alpha1
 */
var SchemasWafFirewallVersionDataAttributes = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SchemasWafFirewallVersionDataAttributes</code>.
   * @alias module:model/SchemasWafFirewallVersionDataAttributes
   */
  function SchemasWafFirewallVersionDataAttributes() {
    _classCallCheck(this, SchemasWafFirewallVersionDataAttributes);
  ...
  _createClass(SchemasWafFirewallVersionDataAttributes, null, [{
    key: "initialize",
     ...
     * @param {module:model/SchemasWafFirewallVersionDataAttributes} obj Optional instance to populate.
     * @return {module:model/SchemasWafFirewallVersionDataAttributes} The populated <code>SchemasWafFirewallVersionDataAttributes</code> instance.
     */
  ...
  return SchemasWafFirewallVersionDataAttributes;
}();
/**
...
var _default = SchemasWafFirewallVersionDataAttributes;
