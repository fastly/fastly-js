...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Billing.AccountBillingApi();
  });
  ...
  describe('AccountBillingApi', function() {
    ...
    describe('getInvoiceMtd', function() {
      it('should call getInvoiceMtd successfully', function(done) {
        //uncomment below and update the code to test getInvoiceMtd
        //instance.getInvoiceMtd(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
