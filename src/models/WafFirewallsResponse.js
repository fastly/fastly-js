 ...
 * @module models/WafFirewallsResponse
 * @version 3.0.0-alpha1
 */
class WafFirewallsResponse {
    /**
     * Constructs a new <code>WafFirewallsResponse</code>.
     * @alias module:models/WafFirewallsResponse
     * @implements module:models/Pagination
     * @implements module:models/WafFirewallsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafFirewallsResponse} obj Optional instance to populate.
     * @return {module:models/WafFirewallsResponse} The populated <code>WafFirewallsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafFirewallResponseData>} data
 */
WafFirewallsResponse.prototype['data'] = undefined;

/**
 * @member {Array.<module:models/SchemasWafFirewallVersion>} included
 */
