...
class ServiceCreateAllOf {
     ...
     * @param {module:models/ServiceCreateAllOf} obj Optional instance to populate.
     * @return {module:models/ServiceCreateAllOf} The populated <code>ServiceCreateAllOf</code> instance.
     */
