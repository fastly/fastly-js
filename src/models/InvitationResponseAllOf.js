...
class InvitationResponseAllOf {
     ...
     * @param {module:models/InvitationResponseAllOf} obj Optional instance to populate.
     * @return {module:models/InvitationResponseAllOf} The populated <code>InvitationResponseAllOf</code> instance.
     */
