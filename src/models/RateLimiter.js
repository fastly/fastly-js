 ...
 * @module models/RateLimiter
 * @version 3.0.0-alpha1
 */
class RateLimiter {
    /**
     * Constructs a new <code>RateLimiter</code>.
     * @alias module:models/RateLimiter
     */
    constructor() { 
     ...
     * @param {module:models/RateLimiter} obj Optional instance to populate.
     * @return {module:models/RateLimiter} The populated <code>RateLimiter</code> instance.
     */
