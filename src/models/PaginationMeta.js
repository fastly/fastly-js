 ...
 * @module models/PaginationMeta
 * @version 3.0.0-alpha1
 */
class PaginationMeta {
    /**
     * Constructs a new <code>PaginationMeta</code>.
     * @alias module:models/PaginationMeta
     */
    constructor() { 
     ...
     * @param {module:models/PaginationMeta} obj Optional instance to populate.
     * @return {module:models/PaginationMeta} The populated <code>PaginationMeta</code> instance.
     */
