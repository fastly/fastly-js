...
class LoggingOpenstackAllOf {
     ...
     * @param {module:models/LoggingOpenstackAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingOpenstackAllOf} The populated <code>LoggingOpenstackAllOf</code> instance.
     */
