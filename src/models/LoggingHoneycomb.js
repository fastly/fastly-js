 ...
 * @module models/LoggingHoneycomb
 * @version 3.0.0-alpha1
 */
class LoggingHoneycomb {
    /**
     * Constructs a new <code>LoggingHoneycomb</code>.
     * @alias module:models/LoggingHoneycomb
     * @implements module:models/LoggingCommon
     * @implements module:models/LoggingHoneycombAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingHoneycomb} obj Optional instance to populate.
     * @return {module:models/LoggingHoneycomb} The populated <code>LoggingHoneycomb</code> instance.
     */
