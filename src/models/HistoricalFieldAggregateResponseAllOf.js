...
class HistoricalFieldAggregateResponseAllOf {
     ...
     * @param {module:models/HistoricalFieldAggregateResponseAllOf} obj Optional instance to populate.
     * @return {module:models/HistoricalFieldAggregateResponseAllOf} The populated <code>HistoricalFieldAggregateResponseAllOf</code> instance.
     */
