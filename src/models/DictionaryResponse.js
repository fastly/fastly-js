 ...
 * @module models/DictionaryResponse
 * @version 3.0.0-alpha1
 */
class DictionaryResponse {
    /**
     * Constructs a new <code>DictionaryResponse</code>.
     * @alias module:models/DictionaryResponse
     * @implements module:models/Dictionary
     * @implements module:models/Timestamps
     * @implements module:models/ServiceIdAndVersion
     * @implements module:models/DictionaryResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/DictionaryResponse} obj Optional instance to populate.
     * @return {module:models/DictionaryResponse} The populated <code>DictionaryResponse</code> instance.
     */
