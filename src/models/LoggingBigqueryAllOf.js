...
class LoggingBigqueryAllOf {
     ...
     * @param {module:models/LoggingBigqueryAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingBigqueryAllOf} The populated <code>LoggingBigqueryAllOf</code> instance.
     */
