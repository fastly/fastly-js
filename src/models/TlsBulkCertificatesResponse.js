 ...
 * @module models/TlsBulkCertificatesResponse
 * @version 3.0.0-alpha1
 */
class TlsBulkCertificatesResponse {
    /**
     * Constructs a new <code>TlsBulkCertificatesResponse</code>.
     * @alias module:models/TlsBulkCertificatesResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsBulkCertificatesResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsBulkCertificatesResponse} obj Optional instance to populate.
     * @return {module:models/TlsBulkCertificatesResponse} The populated <code>TlsBulkCertificatesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsBulkCertificateResponseData>} data
 */
