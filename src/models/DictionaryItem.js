 ...
 * @module models/DictionaryItem
 * @version 3.0.0-alpha1
 */
class DictionaryItem {
    /**
     * Constructs a new <code>DictionaryItem</code>.
     * @alias module:models/DictionaryItem
     */
    constructor() { 
     ...
     * @param {module:models/DictionaryItem} obj Optional instance to populate.
     * @return {module:models/DictionaryItem} The populated <code>DictionaryItem</code> instance.
     */
