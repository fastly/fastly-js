...
class ServerResponseAllOf {
     ...
     * @param {module:models/ServerResponseAllOf} obj Optional instance to populate.
     * @return {module:models/ServerResponseAllOf} The populated <code>ServerResponseAllOf</code> instance.
     */
