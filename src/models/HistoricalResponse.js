 ...
 * @module models/HistoricalResponse
 * @version 3.0.0-alpha1
 */
class HistoricalResponse {
    /**
     * Constructs a new <code>HistoricalResponse</code>.
     * @alias module:models/HistoricalResponse
     * @implements module:models/Historical
     * @implements module:models/HistoricalResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalResponse} obj Optional instance to populate.
     * @return {module:models/HistoricalResponse} The populated <code>HistoricalResponse</code> instance.
     */
...
/**
 * @member {Object.<String, Array.<module:models/Results>>} data
 */
