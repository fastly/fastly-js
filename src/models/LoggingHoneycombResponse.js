 ...
 * @module models/LoggingHoneycombResponse
 * @version 3.0.0-alpha1
 */
class LoggingHoneycombResponse {
    /**
     * Constructs a new <code>LoggingHoneycombResponse</code>.
     * @alias module:models/LoggingHoneycombResponse
     * @implements module:models/LoggingHoneycomb
     ...
     * @param {module:models/LoggingHoneycombResponse} obj Optional instance to populate.
     * @return {module:models/LoggingHoneycombResponse} The populated <code>LoggingHoneycombResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingHoneycombResponse.PlacementEnum} placement
 */
LoggingHoneycombResponse.prototype['placement'] = undefined;

/**
 * The version of the custom logging format used for the configured endpoint. The logging call gets placed by default in `vcl_log` if `format_version` is set to `2` and in `vcl_deliver` if `format_version` is set to `1`.  
 * @member {module:models/LoggingHoneycombResponse.FormatVersionEnum} format_version
...
/**
 * Where in the generated VCL the logging call should be placed. If not set, endpoints with `format_version` of 2 are placed in `vcl_log` and those with `format_version` of 1 are placed in `vcl_deliver`. 
 * @member {module:models/LoggingHoneycomb.PlacementEnum} placement
 */
LoggingHoneycomb.prototype['placement'] = undefined;
/**
 * The version of the custom logging format used for the configured endpoint. The logging call gets placed by default in `vcl_log` if `format_version` is set to `2` and in `vcl_deliver` if `format_version` is set to `1`.  
 * @member {module:models/LoggingHoneycomb.FormatVersionEnum} format_version
 * @default FormatVersionEnum.v2
 */
