 ...
 * @module models/CacheSetting
 * @version 3.0.0-alpha1
 */
class CacheSetting {
    /**
     * Constructs a new <code>CacheSetting</code>.
     * @alias module:models/CacheSetting
     */
    constructor() { 
     ...
     * @param {module:models/CacheSetting} obj Optional instance to populate.
     * @return {module:models/CacheSetting} The populated <code>CacheSetting</code> instance.
     */
