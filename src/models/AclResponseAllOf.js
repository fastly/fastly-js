...
class AclResponseAllOf {
     ...
     * @param {module:models/AclResponseAllOf} obj Optional instance to populate.
     * @return {module:models/AclResponseAllOf} The populated <code>AclResponseAllOf</code> instance.
     */
