...
class TlsActivationData {
     ...
     * @param {module:models/TlsActivationData} obj Optional instance to populate.
     * @return {module:models/TlsActivationData} The populated <code>TlsActivationData</code> instance.
     */
