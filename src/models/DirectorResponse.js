 ...
 * @module models/DirectorResponse
 * @version 3.0.0-alpha1
 */
class DirectorResponse {
    /**
     * Constructs a new <code>DirectorResponse</code>.
     * @alias module:models/DirectorResponse
     * @implements module:models/Director
     ...
     * @param {module:models/DirectorResponse} obj Optional instance to populate.
     * @return {module:models/DirectorResponse} The populated <code>DirectorResponse</code> instance.
     */
 ...
 * @member {Array.<module:models/SchemasBackend>} backends
 */
 ...
 * @member {module:models/DirectorResponse.TypeEnum} type
...
/**
 * What type of load balance group to use.
 * @member {module:models/Director.TypeEnum} type
 * @default TypeEnum.random
 */
