 ...
 * @module models/HistoricalRegionsResponse
 * @version 3.0.0-alpha1
 */
class HistoricalRegionsResponse {
    /**
     * Constructs a new <code>HistoricalRegionsResponse</code>.
     * @alias module:models/HistoricalRegionsResponse
     * @implements module:models/Historical
     * @implements module:models/HistoricalRegionsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalRegionsResponse} obj Optional instance to populate.
     * @return {module:models/HistoricalRegionsResponse} The populated <code>HistoricalRegionsResponse</code> instance.
     */
