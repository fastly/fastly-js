...
class HistoricalMeta {
     ...
     * @alias module:models/HistoricalMeta
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalMeta} obj Optional instance to populate.
     * @return {module:models/HistoricalMeta} The populated <code>HistoricalMeta</code> instance.
     */
