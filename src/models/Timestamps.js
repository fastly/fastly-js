...
class Timestamps {
     ...
     * @alias module:models/Timestamps
     */
    constructor() { 
     ...
     * @param {module:models/Timestamps} obj Optional instance to populate.
     * @return {module:models/Timestamps} The populated <code>Timestamps</code> instance.
     */
