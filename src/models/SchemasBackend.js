 ...
 * @module models/SchemasBackend
 * @version 3.0.0-alpha1
 */
class SchemasBackend {
    /**
     * Constructs a new <code>SchemasBackend</code>.
     * @alias module:models/SchemasBackend
     */
    constructor() { 
     ...
     * @param {module:models/SchemasBackend} obj Optional instance to populate.
     * @return {module:models/SchemasBackend} The populated <code>SchemasBackend</code> instance.
     */
