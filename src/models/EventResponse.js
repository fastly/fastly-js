 ...
 * @module models/EventResponse
 * @version 3.0.0-alpha1
 */
class EventResponse {
    /**
     * Constructs a new <code>EventResponse</code>.
     * @alias module:models/EventResponse
     */
    constructor() { 
     ...
     * @param {module:models/EventResponse} obj Optional instance to populate.
     * @return {module:models/EventResponse} The populated <code>EventResponse</code> instance.
     */
...
/**
 * @member {module:models/Event} data
 */
