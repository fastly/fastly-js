...
class LoggingHoneycombAllOf {
     ...
     * @param {module:models/LoggingHoneycombAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingHoneycombAllOf} The populated <code>LoggingHoneycombAllOf</code> instance.
     */
