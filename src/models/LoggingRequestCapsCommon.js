...
class LoggingRequestCapsCommon {
     ...
     * @param {module:models/LoggingRequestCapsCommon} obj Optional instance to populate.
     * @return {module:models/LoggingRequestCapsCommon} The populated <code>LoggingRequestCapsCommon</code> instance.
     */
