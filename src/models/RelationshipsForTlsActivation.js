...
class RelationshipsForTlsActivation {
     ...
     * @param {module:models/RelationshipsForTlsActivation} obj Optional instance to populate.
     * @return {module:models/RelationshipsForTlsActivation} The populated <code>RelationshipsForTlsActivation</code> instance.
     */
...
/**
 * @member {module:models/RelationshipTlsCertificateTlsCertificate} tls_certificate
 */
