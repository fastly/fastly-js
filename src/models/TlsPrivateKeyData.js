...
class TlsPrivateKeyData {
     ...
     * @param {module:models/TlsPrivateKeyData} obj Optional instance to populate.
     * @return {module:models/TlsPrivateKeyData} The populated <code>TlsPrivateKeyData</code> instance.
     */
