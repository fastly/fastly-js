 ...
 * @module models/DictionaryItemResponse
 * @version 3.0.0-alpha1
 */
class DictionaryItemResponse {
    /**
     * Constructs a new <code>DictionaryItemResponse</code>.
     * @alias module:models/DictionaryItemResponse
     * @implements module:models/DictionaryItem
     * @implements module:models/Timestamps
     * @implements module:models/DictionaryItemResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/DictionaryItemResponse} obj Optional instance to populate.
     * @return {module:models/DictionaryItemResponse} The populated <code>DictionaryItemResponse</code> instance.
     */
