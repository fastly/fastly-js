 ...
 * @module models/WafTagsResponse
 * @version 3.0.0-alpha1
 */
class WafTagsResponse {
    /**
     * Constructs a new <code>WafTagsResponse</code>.
     * @alias module:models/WafTagsResponse
     * @implements module:models/Pagination
     * @implements module:models/WafTagsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafTagsResponse} obj Optional instance to populate.
     * @return {module:models/WafTagsResponse} The populated <code>WafTagsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafTag>} data
 */
