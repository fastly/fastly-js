...
class LoggingSumologicAllOf {
     ...
     * @param {module:models/LoggingSumologicAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingSumologicAllOf} The populated <code>LoggingSumologicAllOf</code> instance.
     */
