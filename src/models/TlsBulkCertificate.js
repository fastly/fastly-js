...
class TlsBulkCertificate {
     ...
     * @param {module:models/TlsBulkCertificate} obj Optional instance to populate.
     * @return {module:models/TlsBulkCertificate} The populated <code>TlsBulkCertificate</code> instance.
     */
...
/**
 * @member {module:models/TlsBulkCertificateData} data
 */
