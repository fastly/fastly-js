 ...
 * @module models/BillingTotal
 * @version 3.0.0-alpha1
 */
class BillingTotal {
    /**
     * Constructs a new <code>BillingTotal</code>.
     * @alias module:models/BillingTotal
     */
    constructor() { 
     ...
     * @param {module:models/BillingTotal} obj Optional instance to populate.
     * @return {module:models/BillingTotal} The populated <code>BillingTotal</code> instance.
     */
 ...
 * @member {Array.<module:models/BillingTotalExtras>} extras
 */
