 ...
 * @module models/PaginationLinks
 * @version 3.0.0-alpha1
 */
class PaginationLinks {
    /**
     * Constructs a new <code>PaginationLinks</code>.
     * @alias module:models/PaginationLinks
     */
    constructor() { 
     ...
     * @param {module:models/PaginationLinks} obj Optional instance to populate.
     * @return {module:models/PaginationLinks} The populated <code>PaginationLinks</code> instance.
     */
