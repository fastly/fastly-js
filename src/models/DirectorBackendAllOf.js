...
class DirectorBackendAllOf {
     ...
     * @param {module:models/DirectorBackendAllOf} obj Optional instance to populate.
     * @return {module:models/DirectorBackendAllOf} The populated <code>DirectorBackendAllOf</code> instance.
     */
