 ...
 * @module models/BackendResponse
 * @version 3.0.0-alpha1
 */
class BackendResponse {
    /**
     * Constructs a new <code>BackendResponse</code>.
     * @alias module:models/BackendResponse
     * @implements module:models/Backend
     * @implements module:models/Timestamps
     * @implements module:models/ServiceIdAndVersion
     * @implements module:models/BackendResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/BackendResponse} obj Optional instance to populate.
     * @return {module:models/BackendResponse} The populated <code>BackendResponse</code> instance.
     */
