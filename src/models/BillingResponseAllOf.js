...
class BillingResponseAllOf {
     ...
     * @param {module:models/BillingResponseAllOf} obj Optional instance to populate.
     * @return {module:models/BillingResponseAllOf} The populated <code>BillingResponseAllOf</code> instance.
     */
