 ...
 * @module models/TlsPrivateKeysResponse
 * @version 3.0.0-alpha1
 */
class TlsPrivateKeysResponse {
    /**
     * Constructs a new <code>TlsPrivateKeysResponse</code>.
     * @alias module:models/TlsPrivateKeysResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsPrivateKeysResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsPrivateKeysResponse} obj Optional instance to populate.
     * @return {module:models/TlsPrivateKeysResponse} The populated <code>TlsPrivateKeysResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsPrivateKeyResponseData>} data
 */
