 ...
 * @module models/PublicIpList
 * @version 3.0.0-alpha1
 */
class PublicIpList {
    /**
     * Constructs a new <code>PublicIpList</code>.
     * @alias module:models/PublicIpList
     */
    constructor() { 
     ...
     * @param {module:models/PublicIpList} obj Optional instance to populate.
     * @return {module:models/PublicIpList} The populated <code>PublicIpList</code> instance.
     */
