 ...
 * @module models/LoggingHttps
 * @version 3.0.0-alpha1
 */
class LoggingHttps {
    /**
     * Constructs a new <code>LoggingHttps</code>.
     * @alias module:models/LoggingHttps
     ...
     * @implements module:models/LoggingHttpsAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingHttps} obj Optional instance to populate.
     * @return {module:models/LoggingHttps} The populated <code>LoggingHttps</code> instance.
     */
...
/**
 * HTTP method used for request.
 * @member {module:models/LoggingHttpsAllOf.MethodEnum} method
 * @default 'POST'
 */
LoggingHttpsAllOf.prototype['method'] = undefined;
/**
 * Enforces valid JSON formatting for log entries.
 * @member {module:models/LoggingHttpsAllOf.JsonFormatEnum} json_format
 */
