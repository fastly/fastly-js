 ...
 * @module models/TokenCreatedResponse
 * @version 3.0.0-alpha1
 */
class TokenCreatedResponse {
    /**
     * Constructs a new <code>TokenCreatedResponse</code>.
     * @alias module:models/TokenCreatedResponse
     * @implements module:models/TokenResponse
     * @implements module:models/TokenCreatedResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TokenCreatedResponse} obj Optional instance to populate.
     * @return {module:models/TokenCreatedResponse} The populated <code>TokenCreatedResponse</code> instance.
     */
 ...
 * @member {module:models/TokenCreatedResponse.ScopeEnum} scope
 * @default 'global'
 */
...
/**
 * Space-delimited list of authorization scope.
 * @member {module:models/TokenResponse.ScopeEnum} scope
 * @default 'global'
 */
