 ...
 * @module models/LoggingSumologicResponse
 * @version 3.0.0-alpha1
 */
class LoggingSumologicResponse {
    /**
     * Constructs a new <code>LoggingSumologicResponse</code>.
     * @alias module:models/LoggingSumologicResponse
     * @implements module:models/LoggingSumologic
     ...
     * @param {module:models/LoggingSumologicResponse} obj Optional instance to populate.
     * @return {module:models/LoggingSumologicResponse} The populated <code>LoggingSumologicResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingSumologicResponse.FormatVersionEnum} format_version
 ...
 * @member {module:models/LoggingSumologicResponse.PlacementEnum} placement
 */
...
/**
 * The version of the custom logging format used for the configured endpoint. The logging call gets placed by default in `vcl_log` if `format_version` is set to `2` and in `vcl_deliver` if `format_version` is set to `1`.  
 * @member {module:models/LoggingSumologic.FormatVersionEnum} format_version
 * @default FormatVersionEnum.v2
 */
...
/**
 * Where in the generated VCL the logging call should be placed. If not set, endpoints with `format_version` of 2 are placed in `vcl_log` and those with `format_version` of 1 are placed in `vcl_deliver`. 
 * @member {module:models/LoggingSumologic.PlacementEnum} placement
 */
