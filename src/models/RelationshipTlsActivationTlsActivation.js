...
class RelationshipTlsActivationTlsActivation {
     ...
     * @param {module:models/RelationshipTlsActivationTlsActivation} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsActivationTlsActivation} The populated <code>RelationshipTlsActivationTlsActivation</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberTlsActivation>} data
 */
