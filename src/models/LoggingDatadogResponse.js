 ...
 * @module models/LoggingDatadogResponse
 * @version 3.0.0-alpha1
 */
class LoggingDatadogResponse {
    /**
     * Constructs a new <code>LoggingDatadogResponse</code>.
     * @alias module:models/LoggingDatadogResponse
     * @implements module:models/LoggingDatadog
     ...
     * @param {module:models/LoggingDatadogResponse} obj Optional instance to populate.
     * @return {module:models/LoggingDatadogResponse} The populated <code>LoggingDatadogResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingDatadogResponse.PlacementEnum} placement
 */
LoggingDatadogResponse.prototype['placement'] = undefined;

/**
 * The version of the custom logging format used for the configured endpoint. The logging call gets placed by default in `vcl_log` if `format_version` is set to `2` and in `vcl_deliver` if `format_version` is set to `1`.  
 * @member {module:models/LoggingDatadogResponse.FormatVersionEnum} format_version
 ...
 * @member {module:models/LoggingDatadogResponse.RegionEnum} region
 * @default 'US'
 */
