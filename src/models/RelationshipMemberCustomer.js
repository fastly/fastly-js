...
class RelationshipMemberCustomer {
     ...
     * @param {module:models/RelationshipMemberCustomer} obj Optional instance to populate.
     * @return {module:models/RelationshipMemberCustomer} The populated <code>RelationshipMemberCustomer</code> instance.
     */
...
/**
 * @member {module:models/TypeCustomer} type
 */
