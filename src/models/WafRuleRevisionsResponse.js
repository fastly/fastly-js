 ...
 * @module models/WafRuleRevisionsResponse
 * @version 3.0.0-alpha1
 */
class WafRuleRevisionsResponse {
    /**
     * Constructs a new <code>WafRuleRevisionsResponse</code>.
     * @alias module:models/WafRuleRevisionsResponse
     * @implements module:models/Pagination
     * @implements module:models/WafRuleRevisionsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafRuleRevisionsResponse} obj Optional instance to populate.
     * @return {module:models/WafRuleRevisionsResponse} The populated <code>WafRuleRevisionsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafRuleRevisionResponseData>} data
 */
WafRuleRevisionsResponse.prototype['data'] = undefined;

/**
 * @member {Array.<module:models/WafRule>} included
 */
