 ...
 * @module models/TlsActivationsResponse
 * @version 3.0.0-alpha1
 */
class TlsActivationsResponse {
    /**
     * Constructs a new <code>TlsActivationsResponse</code>.
     * @alias module:models/TlsActivationsResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsActivationsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsActivationsResponse} obj Optional instance to populate.
     * @return {module:models/TlsActivationsResponse} The populated <code>TlsActivationsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsActivationResponseData>} data
 */
