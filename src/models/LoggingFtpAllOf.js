...
class LoggingFtpAllOf {
     ...
     * @param {module:models/LoggingFtpAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingFtpAllOf} The populated <code>LoggingFtpAllOf</code> instance.
     */
