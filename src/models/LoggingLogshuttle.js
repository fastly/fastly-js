 ...
 * @module models/LoggingLogshuttle
 * @version 3.0.0-alpha1
 */
class LoggingLogshuttle {
    /**
     * Constructs a new <code>LoggingLogshuttle</code>.
     * @alias module:models/LoggingLogshuttle
     * @implements module:models/LoggingCommon
     * @implements module:models/LoggingLogshuttleAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingLogshuttle} obj Optional instance to populate.
     * @return {module:models/LoggingLogshuttle} The populated <code>LoggingLogshuttle</code> instance.
     */
