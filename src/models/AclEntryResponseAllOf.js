...
class AclEntryResponseAllOf {
     ...
     * @param {module:models/AclEntryResponseAllOf} obj Optional instance to populate.
     * @return {module:models/AclEntryResponseAllOf} The populated <code>AclEntryResponseAllOf</code> instance.
     */
