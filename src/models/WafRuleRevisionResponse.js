...
class WafRuleRevisionResponse {
     ...
     * @param {module:models/WafRuleRevisionResponse} obj Optional instance to populate.
     * @return {module:models/WafRuleRevisionResponse} The populated <code>WafRuleRevisionResponse</code> instance.
     */
...
/**
 * @member {module:models/WafRuleRevisionResponseData} data
 */
