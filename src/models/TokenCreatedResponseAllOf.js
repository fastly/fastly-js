...
class TokenCreatedResponseAllOf {
     ...
     * @param {module:models/TokenCreatedResponseAllOf} obj Optional instance to populate.
     * @return {module:models/TokenCreatedResponseAllOf} The populated <code>TokenCreatedResponseAllOf</code> instance.
     */
