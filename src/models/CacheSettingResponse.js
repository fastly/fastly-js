 ...
 * @module models/CacheSettingResponse
 * @version 3.0.0-alpha1
 */
class CacheSettingResponse {
    /**
     * Constructs a new <code>CacheSettingResponse</code>.
     * @alias module:models/CacheSettingResponse
     * @implements module:models/CacheSetting
     ...
     * @param {module:models/CacheSettingResponse} obj Optional instance to populate.
     * @return {module:models/CacheSettingResponse} The populated <code>CacheSettingResponse</code> instance.
     */
 ...
 * @member {module:models/CacheSettingResponse.ActionEnum} action
 */
...
/**
 * If set, will cause vcl_fetch to terminate after processing this rule with the return state specified. If not set, other configuration logic in vcl_fetch with a lower priority will run after this rule. 
 * @member {module:models/CacheSetting.ActionEnum} action
 */
