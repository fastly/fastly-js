 ...
 * @module models/RelationshipTlsSubscriptionTlsSubscription
...
class RelationshipTlsSubscriptionTlsSubscription {
     ...
     * @alias module:models/RelationshipTlsSubscriptionTlsSubscription
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipTlsSubscriptionTlsSubscription} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsSubscriptionTlsSubscription} The populated <code>RelationshipTlsSubscriptionTlsSubscription</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberTlsSubscription>} data
 */
