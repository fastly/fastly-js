...
class Package {
     ...
     * @param {module:models/Package} obj Optional instance to populate.
     * @return {module:models/Package} The populated <code>Package</code> instance.
     */
