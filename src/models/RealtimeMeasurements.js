 ...
 * @module models/RealtimeMeasurements
...
class RealtimeMeasurements {
     ...
     * @alias module:models/RealtimeMeasurements
     */
    constructor() { 
     ...
     * @param {module:models/RealtimeMeasurements} obj Optional instance to populate.
     * @return {module:models/RealtimeMeasurements} The populated <code>RealtimeMeasurements</code> instance.
     */
