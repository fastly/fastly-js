 ...
 * @module models/BillingEstimateResponse
 * @version 3.0.0-alpha1
 */
class BillingEstimateResponse {
    /**
     * Constructs a new <code>BillingEstimateResponse</code>.
     * @alias module:models/BillingEstimateResponse
     * @implements module:models/Billing
     * @implements module:models/BillingEstimateResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/BillingEstimateResponse} obj Optional instance to populate.
     * @return {module:models/BillingEstimateResponse} The populated <code>BillingEstimateResponse</code> instance.
     */
...
/**
 * @member {module:models/BillingStatus} status
 */
BillingEstimateResponse.prototype['status'] = undefined;

/**
 * @member {module:models/BillingTotal} total
 */
