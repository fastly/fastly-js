 ...
 * @module models/Snippet
 * @version 3.0.0-alpha1
 */
class Snippet {
    /**
     * Constructs a new <code>Snippet</code>.
     * @alias module:models/Snippet
     */
    constructor() { 
     ...
     * @param {module:models/Snippet} obj Optional instance to populate.
     * @return {module:models/Snippet} The populated <code>Snippet</code> instance.
     */
