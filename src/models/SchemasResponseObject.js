...
class SchemasResponseObject {
     ...
     * @param {module:models/SchemasResponseObject} obj Optional instance to populate.
     * @return {module:models/SchemasResponseObject} The populated <code>SchemasResponseObject</code> instance.
     */
