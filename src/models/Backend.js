 ...
 * @module models/Backend
 * @version 3.0.0-alpha1
 */
class Backend {
    /**
     * Constructs a new <code>Backend</code>.
     * @alias module:models/Backend
     */
    constructor() { 
     ...
     * @param {module:models/Backend} obj Optional instance to populate.
     * @return {module:models/Backend} The populated <code>Backend</code> instance.
     */
