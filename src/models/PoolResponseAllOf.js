...
class PoolResponseAllOf {
     ...
     * @param {module:models/PoolResponseAllOf} obj Optional instance to populate.
     * @return {module:models/PoolResponseAllOf} The populated <code>PoolResponseAllOf</code> instance.
     */
