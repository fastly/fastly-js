...
class TlsConfigurationData {
     ...
     * @param {module:models/TlsConfigurationData} obj Optional instance to populate.
     * @return {module:models/TlsConfigurationData} The populated <code>TlsConfigurationData</code> instance.
     */
