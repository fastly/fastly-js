 ...
 * @module models/ServiceAuthorizationsResponse
 * @version 3.0.0-alpha1
 */
class ServiceAuthorizationsResponse {
    /**
     * Constructs a new <code>ServiceAuthorizationsResponse</code>.
     * @alias module:models/ServiceAuthorizationsResponse
     * @implements module:models/Pagination
     * @implements module:models/ServiceAuthorizationsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/ServiceAuthorizationsResponse} obj Optional instance to populate.
     * @return {module:models/ServiceAuthorizationsResponse} The populated <code>ServiceAuthorizationsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/ServiceAuthorizationResponseData>} data
 */
