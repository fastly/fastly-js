...
class Results {
     ...
     * @param {module:models/Results} obj Optional instance to populate.
     * @return {module:models/Results} The populated <code>Results</code> instance.
     */
