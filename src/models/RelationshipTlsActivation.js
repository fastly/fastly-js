...
class RelationshipTlsActivation {
     ...
     * @param {module:models/RelationshipTlsActivation} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsActivation} The populated <code>RelationshipTlsActivation</code> instance.
     */
...
/**
 * @member {module:models/RelationshipTlsActivationTlsActivation} tls_activation
 */
