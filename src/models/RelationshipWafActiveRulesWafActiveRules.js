...
class RelationshipWafActiveRulesWafActiveRules {
     ...
     * @param {module:models/RelationshipWafActiveRulesWafActiveRules} obj Optional instance to populate.
     * @return {module:models/RelationshipWafActiveRulesWafActiveRules} The populated <code>RelationshipWafActiveRulesWafActiveRules</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberWafActiveRule>} data
 */
