 ...
 * @module models/VclResponse
 * @version 3.0.0-alpha1
 */
class VclResponse {
    /**
     * Constructs a new <code>VclResponse</code>.
     * @alias module:models/VclResponse
     ...
     * @param {module:models/VclResponse} obj Optional instance to populate.
     * @return {module:models/VclResponse} The populated <code>VclResponse</code> instance.
     */
