 ...
 * @module models/RateLimiterResponse1
...
class RateLimiterResponse1 {
     ...
     * @alias module:models/RateLimiterResponse1
     */
    constructor() { 
     ...
     * @param {module:models/RateLimiterResponse1} obj Optional instance to populate.
     * @return {module:models/RateLimiterResponse1} The populated <code>RateLimiterResponse1</code> instance.
     */
