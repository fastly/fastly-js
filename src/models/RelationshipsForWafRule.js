 ...
 * @module models/RelationshipsForWafRule
 * @version 3.0.0-alpha1
 */
class RelationshipsForWafRule {
    /**
     * Constructs a new <code>RelationshipsForWafRule</code>.
     * @alias module:models/RelationshipsForWafRule
     * @implements module:models/RelationshipWafTags
     ...
     * @param {module:models/RelationshipsForWafRule} obj Optional instance to populate.
     * @return {module:models/RelationshipsForWafRule} The populated <code>RelationshipsForWafRule</code> instance.
     */
...
/**
 * @member {module:models/RelationshipWafTagsWafTags} waf_tags
 */
