 ...
 * @module models/GzipResponse
 * @version 3.0.0-alpha1
 */
class GzipResponse {
    /**
     * Constructs a new <code>GzipResponse</code>.
     * @alias module:models/GzipResponse
     * @implements module:models/Gzip
     ...
     * @param {module:models/GzipResponse} obj Optional instance to populate.
     * @return {module:models/GzipResponse} The populated <code>GzipResponse</code> instance.
     */
