...
class SnippetResponse {
     ...
     * @param {module:models/SnippetResponse} obj Optional instance to populate.
     * @return {module:models/SnippetResponse} The populated <code>SnippetResponse</code> instance.
     */
 ...
 * @member {module:models/SnippetResponse.DynamicEnum} dynamic
 */
