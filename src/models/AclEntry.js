 ...
 * @module models/AclEntry
 * @version 3.0.0-alpha1
 */
class AclEntry {
    /**
     * Constructs a new <code>AclEntry</code>.
     * @alias module:models/AclEntry
     */
    constructor() { 
     ...
     * @param {module:models/AclEntry} obj Optional instance to populate.
     * @return {module:models/AclEntry} The populated <code>AclEntry</code> instance.
     */
