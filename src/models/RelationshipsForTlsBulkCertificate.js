 ...
 * @module models/RelationshipsForTlsBulkCertificate
 * @version 3.0.0-alpha1
 */
class RelationshipsForTlsBulkCertificate {
    /**
     * Constructs a new <code>RelationshipsForTlsBulkCertificate</code>.
     * @alias module:models/RelationshipsForTlsBulkCertificate
     * @implements module:models/RelationshipTlsConfigurations
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipsForTlsBulkCertificate} obj Optional instance to populate.
     * @return {module:models/RelationshipsForTlsBulkCertificate} The populated <code>RelationshipsForTlsBulkCertificate</code> instance.
     */
...
/**
 * @member {module:models/RelationshipTlsConfigurationTlsConfiguration} tls_configurations
 */
