...
class RateLimiterResponseAllOf {
     ...
     * @param {module:models/RateLimiterResponseAllOf} obj Optional instance to populate.
     * @return {module:models/RateLimiterResponseAllOf} The populated <code>RateLimiterResponseAllOf</code> instance.
     */
