...
class RelationshipMemberWafFirewallVersion {
     ...
     * @param {module:models/RelationshipMemberWafFirewallVersion} obj Optional instance to populate.
     * @return {module:models/RelationshipMemberWafFirewallVersion} The populated <code>RelationshipMemberWafFirewallVersion</code> instance.
     */
