 ...
 * @module models/LoggingHeroku
 * @version 3.0.0-alpha1
 */
class LoggingHeroku {
    /**
     * Constructs a new <code>LoggingHeroku</code>.
     * @alias module:models/LoggingHeroku
     * @implements module:models/LoggingCommon
     * @implements module:models/LoggingHerokuAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingHeroku} obj Optional instance to populate.
     * @return {module:models/LoggingHeroku} The populated <code>LoggingHeroku</code> instance.
     */
