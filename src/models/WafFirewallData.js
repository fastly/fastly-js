...
class WafFirewallData {
     ...
     * @param {module:models/WafFirewallData} obj Optional instance to populate.
     * @return {module:models/WafFirewallData} The populated <code>WafFirewallData</code> instance.
     */
