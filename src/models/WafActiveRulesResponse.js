 ...
 * @module models/WafActiveRulesResponse
 * @version 3.0.0-alpha1
 */
class WafActiveRulesResponse {
    /**
     * Constructs a new <code>WafActiveRulesResponse</code>.
     * @alias module:models/WafActiveRulesResponse
     * @implements module:models/Pagination
     * @implements module:models/WafActiveRulesResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafActiveRulesResponse} obj Optional instance to populate.
     * @return {module:models/WafActiveRulesResponse} The populated <code>WafActiveRulesResponse</code> instance.
     */
