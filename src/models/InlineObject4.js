 ...
 * @module models/InlineObject4
 * @version 3.0.0-alpha1
 */
class InlineObject4 {
    /**
     * Constructs a new <code>InlineObject4</code>.
     * @alias module:models/InlineObject4
     */
    constructor() { 
     ...
     * @param {module:models/InlineObject4} obj Optional instance to populate.
     * @return {module:models/InlineObject4} The populated <code>InlineObject4</code> instance.
     */
