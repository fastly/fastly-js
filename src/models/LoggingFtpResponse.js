 ...
 * @module models/LoggingFtpResponse
 * @version 3.0.0-alpha1
 */
class LoggingFtpResponse {
    /**
     * Constructs a new <code>LoggingFtpResponse</code>.
     * @alias module:models/LoggingFtpResponse
     * @implements module:models/LoggingFtp
     ...
     * @param {module:models/LoggingFtpResponse} obj Optional instance to populate.
     * @return {module:models/LoggingFtpResponse} The populated <code>LoggingFtpResponse</code> instance.
     */
