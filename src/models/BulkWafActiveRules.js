...
class BulkWafActiveRules {
     ...
     * @param {module:models/BulkWafActiveRules} obj Optional instance to populate.
     * @return {module:models/BulkWafActiveRules} The populated <code>BulkWafActiveRules</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafActiveRuleData>} data
 */
