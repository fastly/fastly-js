 ...
 * @module models/StarResponse
 * @version 3.0.0-alpha1
 */
class StarResponse {
    /**
     * Constructs a new <code>StarResponse</code>.
     * @alias module:models/StarResponse
     * @implements module:models/Star
     * @implements module:models/StarResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/StarResponse} obj Optional instance to populate.
     * @return {module:models/StarResponse} The populated <code>StarResponse</code> instance.
     */
...
/**
 * @member {module:models/StarData} data
 */
