...
class LoggingGooglePubsubAllOf {
     ...
     * @param {module:models/LoggingGooglePubsubAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingGooglePubsubAllOf} The populated <code>LoggingGooglePubsubAllOf</code> instance.
     */
