 ...
 * @module models/LoggingScalyr
 * @version 3.0.0-alpha1
 */
class LoggingScalyr {
    /**
     * Constructs a new <code>LoggingScalyr</code>.
     * @alias module:models/LoggingScalyr
     * @implements module:models/LoggingCommon
     * @implements module:models/LoggingScalyrAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingScalyr} obj Optional instance to populate.
     * @return {module:models/LoggingScalyr} The populated <code>LoggingScalyr</code> instance.
     */
 ...
 * @member {module:models/LoggingScalyr.FormatVersionEnum} format_version
 ...
 * @member {module:models/LoggingScalyr.PlacementEnum} placement
 */
...
/**
 * The region that log data will be sent to.
 * @member {module:models/LoggingScalyrAllOf.RegionEnum} region
 * @default 'US'
 */
