...
class Invitation {
     ...
     * @alias module:models/Invitation
     */
    constructor() { 
     ...
     * @param {module:models/Invitation} obj Optional instance to populate.
     * @return {module:models/Invitation} The populated <code>Invitation</code> instance.
     */
