...
class Header {
     ...
     * @param {module:models/Header} obj Optional instance to populate.
     * @return {module:models/Header} The populated <code>Header</code> instance.
     */
