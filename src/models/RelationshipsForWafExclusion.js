 ...
 * @module models/RelationshipsForWafExclusion
 * @version 3.0.0-alpha1
 */
class RelationshipsForWafExclusion {
    /**
     * Constructs a new <code>RelationshipsForWafExclusion</code>.
     * @alias module:models/RelationshipsForWafExclusion
     * @implements module:models/RelationshipWafRules
     * @implements module:models/RelationshipWafRuleRevisions
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipsForWafExclusion} obj Optional instance to populate.
     * @return {module:models/RelationshipsForWafExclusion} The populated <code>RelationshipsForWafExclusion</code> instance.
     */
...
/**
 * @member {module:models/RelationshipWafRuleWafRule} waf_rules
 */
