...
class LoggingSplunkAllOf {
     ...
     * @param {module:models/LoggingSplunkAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingSplunkAllOf} The populated <code>LoggingSplunkAllOf</code> instance.
     */
