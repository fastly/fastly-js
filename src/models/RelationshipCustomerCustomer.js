...
class RelationshipCustomerCustomer {
     ...
     * @param {module:models/RelationshipCustomerCustomer} obj Optional instance to populate.
     * @return {module:models/RelationshipCustomerCustomer} The populated <code>RelationshipCustomerCustomer</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberCustomer>} data
 */
