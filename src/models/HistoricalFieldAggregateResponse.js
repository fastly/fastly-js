 ...
 * @module models/HistoricalFieldAggregateResponse
 * @version 3.0.0-alpha1
 */
class HistoricalFieldAggregateResponse {
    /**
     * Constructs a new <code>HistoricalFieldAggregateResponse</code>.
     * @alias module:models/HistoricalFieldAggregateResponse
     * @implements module:models/Historical
     * @implements module:models/HistoricalFieldAggregateResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalFieldAggregateResponse} obj Optional instance to populate.
     * @return {module:models/HistoricalFieldAggregateResponse} The populated <code>HistoricalFieldAggregateResponse</code> instance.
     */
