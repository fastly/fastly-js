...
class WafFirewallVersionData {
     ...
     * @param {module:models/WafFirewallVersionData} obj Optional instance to populate.
     * @return {module:models/WafFirewallVersionData} The populated <code>WafFirewallVersionData</code> instance.
     */
