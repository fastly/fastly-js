...
class WafActiveRuleData {
     ...
     * @param {module:models/WafActiveRuleData} obj Optional instance to populate.
     * @return {module:models/WafActiveRuleData} The populated <code>WafActiveRuleData</code> instance.
     */
