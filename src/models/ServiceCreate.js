 ...
 * @module models/ServiceCreate
 * @version 3.0.0-alpha1
 */
class ServiceCreate {
    /**
     * Constructs a new <code>ServiceCreate</code>.
     * @alias module:models/ServiceCreate
     * @implements module:models/Service
     * @implements module:models/ServiceCreateAllOf
     */
    constructor() { 
     ...
     * @param {module:models/ServiceCreate} obj Optional instance to populate.
     * @return {module:models/ServiceCreate} The populated <code>ServiceCreate</code> instance.
     */
...
/**
 * The type of this service.
 * @member {module:models/ServiceCreateAllOf.TypeEnum} type
 */
