...
class RelationshipTlsPrivateKeyTlsPrivateKey {
     ...
     * @param {module:models/RelationshipTlsPrivateKeyTlsPrivateKey} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsPrivateKeyTlsPrivateKey} The populated <code>RelationshipTlsPrivateKeyTlsPrivateKey</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberTlsPrivateKey>} data
 */
