 ...
 * @module models/Condition
 * @version 3.0.0-alpha1
 */
class Condition {
    /**
     * Constructs a new <code>Condition</code>.
     * @alias module:models/Condition
     */
    constructor() { 
     ...
     * @param {module:models/Condition} obj Optional instance to populate.
     * @return {module:models/Condition} The populated <code>Condition</code> instance.
     */
