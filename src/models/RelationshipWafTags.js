...
class RelationshipWafTags {
     ...
     * @param {module:models/RelationshipWafTags} obj Optional instance to populate.
     * @return {module:models/RelationshipWafTags} The populated <code>RelationshipWafTags</code> instance.
     */
