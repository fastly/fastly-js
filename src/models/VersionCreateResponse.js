 ...
 * @module models/VersionCreateResponse
 * @version 3.0.0-alpha1
 */
class VersionCreateResponse {
    /**
     * Constructs a new <code>VersionCreateResponse</code>.
     * @alias module:models/VersionCreateResponse
     */
    constructor() { 
     ...
     * @param {module:models/VersionCreateResponse} obj Optional instance to populate.
     * @return {module:models/VersionCreateResponse} The populated <code>VersionCreateResponse</code> instance.
     */
