...
class PackageResponseAllOf {
     ...
     * @param {module:models/PackageResponseAllOf} obj Optional instance to populate.
     * @return {module:models/PackageResponseAllOf} The populated <code>PackageResponseAllOf</code> instance.
     */
