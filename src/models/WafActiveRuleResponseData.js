 ...
 * @module models/WafActiveRuleResponseData
 * @version 3.0.0-alpha1
 */
class WafActiveRuleResponseData {
    /**
     * Constructs a new <code>WafActiveRuleResponseData</code>.
     * @alias module:models/WafActiveRuleResponseData
     * @implements module:models/WafActiveRuleData
     * @implements module:models/WafActiveRuleResponseDataAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafActiveRuleResponseData} obj Optional instance to populate.
     * @return {module:models/WafActiveRuleResponseData} The populated <code>WafActiveRuleResponseData</code> instance.
     */
...
/**
 * @member {module:models/AnyOfrelationshipWafFirewallVersionrelationshipWafRuleRevision} relationships
 */
