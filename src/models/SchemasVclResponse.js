 ...
 * @module models/SchemasVclResponse
 * @version 3.0.0-alpha1
 */
class SchemasVclResponse {
    /**
     * Constructs a new <code>SchemasVclResponse</code>.
     * @alias module:models/SchemasVclResponse
     * @implements module:models/Vcl
     ...
     * @param {module:models/SchemasVclResponse} obj Optional instance to populate.
     * @return {module:models/SchemasVclResponse} The populated <code>SchemasVclResponse</code> instance.
     */
