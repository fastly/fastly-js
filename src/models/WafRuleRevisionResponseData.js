 ...
 * @module models/WafRuleRevisionResponseData
 * @version 3.0.0-alpha1
 */
class WafRuleRevisionResponseData {
    /**
     * Constructs a new <code>WafRuleRevisionResponseData</code>.
     * @alias module:models/WafRuleRevisionResponseData
     * @implements module:models/WafRuleRevision
     * @implements module:models/WafRuleRevisionResponseDataAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafRuleRevisionResponseData} obj Optional instance to populate.
     * @return {module:models/WafRuleRevisionResponseData} The populated <code>WafRuleRevisionResponseData</code> instance.
     */
