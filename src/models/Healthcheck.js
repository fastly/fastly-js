 ...
 * @module models/Healthcheck
 * @version 3.0.0-alpha1
 */
class Healthcheck {
    /**
     * Constructs a new <code>Healthcheck</code>.
     * @alias module:models/Healthcheck
     */
    constructor() { 
     ...
     * @param {module:models/Healthcheck} obj Optional instance to populate.
     * @return {module:models/Healthcheck} The populated <code>Healthcheck</code> instance.
     */
