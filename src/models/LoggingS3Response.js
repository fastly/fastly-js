 ...
 * @module models/LoggingS3Response
 * @version 3.0.0-alpha1
 */
class LoggingS3Response {
    /**
     * Constructs a new <code>LoggingS3Response</code>.
     * @alias module:models/LoggingS3Response
     * @implements module:models/LoggingS3
     ...
     * @param {module:models/LoggingS3Response} obj Optional instance to populate.
     * @return {module:models/LoggingS3Response} The populated <code>LoggingS3Response</code> instance.
     */
 ...
 * @member {module:models/LoggingS3Response.FormatVersionEnum} format_version
 ...
 * @member {module:models/LoggingS3Response.PlacementEnum} placement
 */
 ...
 * @member {module:models/LoggingS3Response.CompressionCodecEnum} compression_codec
 */
 ...
 * @member {module:models/LoggingS3Response.MessageTypeEnum} message_type
 * @default 'classic'
 */
