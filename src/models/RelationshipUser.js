...
class RelationshipUser {
     ...
     * @param {module:models/RelationshipUser} obj Optional instance to populate.
     * @return {module:models/RelationshipUser} The populated <code>RelationshipUser</code> instance.
     */
...
/**
 * @member {module:models/RelationshipUserUser} user
 */
