...
class Token {
     ...
     * @param {module:models/Token} obj Optional instance to populate.
     * @return {module:models/Token} The populated <code>Token</code> instance.
     */
 ...
 * @member {module:models/Token.ScopeEnum} scope
 * @default 'global'
 */
