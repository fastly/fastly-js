 ...
 * @module models/WafFirewall
 * @version 3.0.0-alpha1
 */
class WafFirewall {
    /**
     * Constructs a new <code>WafFirewall</code>.
     * @alias module:models/WafFirewall
     */
    constructor() { 
     ...
     * @param {module:models/WafFirewall} obj Optional instance to populate.
     * @return {module:models/WafFirewall} The populated <code>WafFirewall</code> instance.
     */
...
/**
 * @member {module:models/WafFirewallData} data
 */
