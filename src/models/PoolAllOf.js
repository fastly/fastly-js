 ...
 * @module models/PoolAllOf
 * @version 3.0.0-alpha1
 */
class PoolAllOf {
    /**
     * Constructs a new <code>PoolAllOf</code>.
     * @alias module:models/PoolAllOf
     */
    constructor() { 
     ...
     * @param {module:models/PoolAllOf} obj Optional instance to populate.
     * @return {module:models/PoolAllOf} The populated <code>PoolAllOf</code> instance.
     */
