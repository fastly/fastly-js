...
class ServiceInvitation {
     ...
     * @param {module:models/ServiceInvitation} obj Optional instance to populate.
     * @return {module:models/ServiceInvitation} The populated <code>ServiceInvitation</code> instance.
     */
