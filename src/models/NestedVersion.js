 ...
 * @module models/NestedVersion
 * @version 3.0.0-alpha1
 */
class NestedVersion {
    /**
     * Constructs a new <code>NestedVersion</code>.
     * @alias module:models/NestedVersion
     * @implements module:models/SchemasVersionResponse
     * @implements module:models/VersionDetail
     */
    constructor() { 
     ...
     * @param {module:models/NestedVersion} obj Optional instance to populate.
     * @return {module:models/NestedVersion} The populated <code>NestedVersion</code> instance.
     */
 ...
 * @member {Array.<module:models/BackendResponse>} backends
 */
NestedVersion.prototype['backends'] = undefined;

/**
 * List of cache settings associated to this service.
 * @member {Array.<module:models/CacheSettingResponse>} cache_settings
 */
 ...
 * @member {Array.<module:models/SchemasDirector>} directors
 */
