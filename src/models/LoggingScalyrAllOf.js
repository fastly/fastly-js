...
class LoggingScalyrAllOf {
     ...
     * @param {module:models/LoggingScalyrAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingScalyrAllOf} The populated <code>LoggingScalyrAllOf</code> instance.
     */
