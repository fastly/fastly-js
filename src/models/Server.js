...
class Server {
     ...
     * @param {module:models/Server} obj Optional instance to populate.
     * @return {module:models/Server} The populated <code>Server</code> instance.
     */
