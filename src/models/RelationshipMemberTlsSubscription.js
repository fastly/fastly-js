...
class RelationshipMemberTlsSubscription {
     ...
     * @param {module:models/RelationshipMemberTlsSubscription} obj Optional instance to populate.
     * @return {module:models/RelationshipMemberTlsSubscription} The populated <code>RelationshipMemberTlsSubscription</code> instance.
     */
