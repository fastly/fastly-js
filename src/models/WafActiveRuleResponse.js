...
class WafActiveRuleResponse {
     ...
     * @param {module:models/WafActiveRuleResponse} obj Optional instance to populate.
     * @return {module:models/WafActiveRuleResponse} The populated <code>WafActiveRuleResponse</code> instance.
     */
