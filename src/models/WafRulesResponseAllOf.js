...
class WafRulesResponseAllOf {
     ...
     * @param {module:models/WafRulesResponseAllOf} obj Optional instance to populate.
     * @return {module:models/WafRulesResponseAllOf} The populated <code>WafRulesResponseAllOf</code> instance.
     */
