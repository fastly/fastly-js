...
class TlsConfigurationResponse {
     ...
     * @param {module:models/TlsConfigurationResponse} obj Optional instance to populate.
     * @return {module:models/TlsConfigurationResponse} The populated <code>TlsConfigurationResponse</code> instance.
     */
...
/**
 * @member {module:models/TlsConfigurationResponseData} data
 */
