...
class RealtimeEntry {
     ...
     * @alias module:models/RealtimeEntry
     */
    constructor() { 
     ...
     * @param {module:models/RealtimeEntry} obj Optional instance to populate.
     * @return {module:models/RealtimeEntry} The populated <code>RealtimeEntry</code> instance.
     */
...
/**
 * @member {module:models/RealtimeMeasurements} aggregated
 */
 ...
 * @member {Object.<String, module:models/RealtimeMeasurements>} datacenter
 */
