 ...
 * @module models/ServiceAuthorizationResponseData
 * @version 3.0.0-alpha1
 */
class ServiceAuthorizationResponseData {
    /**
     * Constructs a new <code>ServiceAuthorizationResponseData</code>.
     * @alias module:models/ServiceAuthorizationResponseData
     * @implements module:models/ServiceAuthorizationData
     * @implements module:models/ServiceAuthorizationResponseDataAllOf
     */
    constructor() { 
     ...
     * @param {module:models/ServiceAuthorizationResponseData} obj Optional instance to populate.
     * @return {module:models/ServiceAuthorizationResponseData} The populated <code>ServiceAuthorizationResponseData</code> instance.
     */
