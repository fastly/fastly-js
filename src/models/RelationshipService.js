 ...
 * @module models/RelationshipService
 * @version 3.0.0-alpha1
 */
class RelationshipService {
    /**
     * Constructs a new <code>RelationshipService</code>.
     * @alias module:models/RelationshipService
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipService} obj Optional instance to populate.
     * @return {module:models/RelationshipService} The populated <code>RelationshipService</code> instance.
     */
