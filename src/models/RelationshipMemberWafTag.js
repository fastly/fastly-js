...
class RelationshipMemberWafTag {
     ...
     * @param {module:models/RelationshipMemberWafTag} obj Optional instance to populate.
     * @return {module:models/RelationshipMemberWafTag} The populated <code>RelationshipMemberWafTag</code> instance.
     */
