 ...
 * @module models/TlsDnsRecord
 * @version 3.0.0-alpha1
 */
class TlsDnsRecord {
    /**
     * Constructs a new <code>TlsDnsRecord</code>.
     * @alias module:models/TlsDnsRecord
     */
    constructor() { 
     ...
     * @param {module:models/TlsDnsRecord} obj Optional instance to populate.
     * @return {module:models/TlsDnsRecord} The populated <code>TlsDnsRecord</code> instance.
     */
