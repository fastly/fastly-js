 ...
 * @module models/WafTag
 * @version 3.0.0-alpha1
 */
class WafTag {
    /**
     * Constructs a new <code>WafTag</code>.
     * @alias module:models/WafTag
     */
    constructor() { 
     ...
     * @param {module:models/WafTag} obj Optional instance to populate.
     * @return {module:models/WafTag} The populated <code>WafTag</code> instance.
     */
