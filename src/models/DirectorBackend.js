...
class DirectorBackend {
     ...
     * @param {module:models/DirectorBackend} obj Optional instance to populate.
     * @return {module:models/DirectorBackend} The populated <code>DirectorBackend</code> instance.
     */
