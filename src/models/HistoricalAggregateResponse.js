 ...
 * @module models/HistoricalAggregateResponse
 * @version 3.0.0-alpha1
 */
class HistoricalAggregateResponse {
    /**
     * Constructs a new <code>HistoricalAggregateResponse</code>.
     * @alias module:models/HistoricalAggregateResponse
     * @implements module:models/Historical
     * @implements module:models/HistoricalAggregateResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalAggregateResponse} obj Optional instance to populate.
     * @return {module:models/HistoricalAggregateResponse} The populated <code>HistoricalAggregateResponse</code> instance.
     */
