 ...
 * @module models/LoggingNewrelicResponse
 * @version 3.0.0-alpha1
 */
class LoggingNewrelicResponse {
    /**
     * Constructs a new <code>LoggingNewrelicResponse</code>.
     * @alias module:models/LoggingNewrelicResponse
     * @implements module:models/LoggingNewrelic
     ...
     * @param {module:models/LoggingNewrelicResponse} obj Optional instance to populate.
     * @return {module:models/LoggingNewrelicResponse} The populated <code>LoggingNewrelicResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingNewrelicResponse.FormatVersionEnum} format_version
 ...
 * @member {module:models/LoggingNewrelicResponse.PlacementEnum} placement
 */
 ...
 * @member {module:models/LoggingNewrelicResponse.RegionEnum} region
 * @default 'US'
 */
