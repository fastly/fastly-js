 ...
 * @module models/RelationshipTlsConfigurationTlsConfiguration
...
class RelationshipTlsConfigurationTlsConfiguration {
     ...
     * @alias module:models/RelationshipTlsConfigurationTlsConfiguration
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipTlsConfigurationTlsConfiguration} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsConfigurationTlsConfiguration} The populated <code>RelationshipTlsConfigurationTlsConfiguration</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberTlsConfiguration>} data
 */
