 ...
 * @module models/LoggingHttpsResponse
 * @version 3.0.0-alpha1
 */
class LoggingHttpsResponse {
    /**
     * Constructs a new <code>LoggingHttpsResponse</code>.
     * @alias module:models/LoggingHttpsResponse
     * @implements module:models/LoggingHttps
     ...
     * @param {module:models/LoggingHttpsResponse} obj Optional instance to populate.
     * @return {module:models/LoggingHttpsResponse} The populated <code>LoggingHttpsResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingHttpsResponse.MethodEnum} method
 * @default 'POST'
 */
