...
class LoggingS3 {
     ...
     * @param {module:models/LoggingS3} obj Optional instance to populate.
     * @return {module:models/LoggingS3} The populated <code>LoggingS3</code> instance.
     */
