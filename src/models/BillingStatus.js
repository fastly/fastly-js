 ...
 * @module models/BillingStatus
 * @version 3.0.0-alpha1
 */
class BillingStatus {
    /**
     * Constructs a new <code>BillingStatus</code>.
     * @alias module:models/BillingStatus
     */
    constructor() { 
     ...
     * @param {module:models/BillingStatus} obj Optional instance to populate.
     * @return {module:models/BillingStatus} The populated <code>BillingStatus</code> instance.
     */
 ...
 * @member {module:models/BillingStatus.StatusEnum} status
 */
