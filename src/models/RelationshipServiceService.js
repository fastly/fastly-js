...
class RelationshipServiceService {
     ...
     * @param {module:models/RelationshipServiceService} obj Optional instance to populate.
     * @return {module:models/RelationshipServiceService} The populated <code>RelationshipServiceService</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberService>} data
 */
