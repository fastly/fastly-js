...
class BillingAddressData {
     ...
     * @param {module:models/BillingAddressData} obj Optional instance to populate.
     * @return {module:models/BillingAddressData} The populated <code>BillingAddressData</code> instance.
     */
...
/**
 * @member {module:models/BillingAddressDataAttributes} attributes
 */
BillingAddressData.prototype['attributes'] = undefined;

/**
 * @member {module:models/RelationshipCustomer} relationships
 */
