...
class RelationshipsForTlsConfiguration {
     ...
     * @param {module:models/RelationshipsForTlsConfiguration} obj Optional instance to populate.
     * @return {module:models/RelationshipsForTlsConfiguration} The populated <code>RelationshipsForTlsConfiguration</code> instance.
     */
...
/**
 * @member {module:models/RelationshipServiceService} service
 */
