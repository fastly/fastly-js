 ...
 * @module models/TlsDomainsResponse
 * @version 3.0.0-alpha1
 */
class TlsDomainsResponse {
    /**
     * Constructs a new <code>TlsDomainsResponse</code>.
     * @alias module:models/TlsDomainsResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsDomainsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsDomainsResponse} obj Optional instance to populate.
     * @return {module:models/TlsDomainsResponse} The populated <code>TlsDomainsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsDomainData>} data
 */
