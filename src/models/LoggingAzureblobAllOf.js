...
class LoggingAzureblobAllOf {
     ...
     * @param {module:models/LoggingAzureblobAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingAzureblobAllOf} The populated <code>LoggingAzureblobAllOf</code> instance.
     */
