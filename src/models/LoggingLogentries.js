 ...
 * @module models/LoggingLogentries
 * @version 3.0.0-alpha1
 */
class LoggingLogentries {
    /**
     * Constructs a new <code>LoggingLogentries</code>.
     * @alias module:models/LoggingLogentries
     * @implements module:models/LoggingCommon
     * @implements module:models/LoggingLogentriesAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingLogentries} obj Optional instance to populate.
     * @return {module:models/LoggingLogentries} The populated <code>LoggingLogentries</code> instance.
     */
