...
class LoggingKafkaAllOf {
     ...
     * @param {module:models/LoggingKafkaAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingKafkaAllOf} The populated <code>LoggingKafkaAllOf</code> instance.
     */
