...
class ServiceAuthorizationData {
     ...
     * @param {module:models/ServiceAuthorizationData} obj Optional instance to populate.
     * @return {module:models/ServiceAuthorizationData} The populated <code>ServiceAuthorizationData</code> instance.
     */
