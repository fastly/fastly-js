...
class LoggingGcsAllOf {
     ...
     * @param {module:models/LoggingGcsAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingGcsAllOf} The populated <code>LoggingGcsAllOf</code> instance.
     */
