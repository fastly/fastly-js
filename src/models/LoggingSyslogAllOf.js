...
class LoggingSyslogAllOf {
     ...
     * @param {module:models/LoggingSyslogAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingSyslogAllOf} The populated <code>LoggingSyslogAllOf</code> instance.
     */
