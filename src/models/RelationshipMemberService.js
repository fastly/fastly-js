...
class RelationshipMemberService {
     ...
     * @param {module:models/RelationshipMemberService} obj Optional instance to populate.
     * @return {module:models/RelationshipMemberService} The populated <code>RelationshipMemberService</code> instance.
     */
