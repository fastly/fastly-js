...
class WafRuleRevisionAttributes {
     ...
     * @param {module:models/WafRuleRevisionAttributes} obj Optional instance to populate.
     * @return {module:models/WafRuleRevisionAttributes} The populated <code>WafRuleRevisionAttributes</code> instance.
     */
 ...
 * @member {module:models/WafRuleRevisionAttributes.StateEnum} state
 */
