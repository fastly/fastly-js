 ...
 * @module models/InvitationResponseData
 * @version 3.0.0-alpha1
 */
class InvitationResponseData {
    /**
     * Constructs a new <code>InvitationResponseData</code>.
     * @alias module:models/InvitationResponseData
     * @implements module:models/InvitationData
     * @implements module:models/InvitationResponseDataAllOf
     */
    constructor() { 
     ...
     * @param {module:models/InvitationResponseData} obj Optional instance to populate.
     * @return {module:models/InvitationResponseData} The populated <code>InvitationResponseData</code> instance.
     */
