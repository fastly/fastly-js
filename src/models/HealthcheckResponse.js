 ...
 * @module models/HealthcheckResponse
 * @version 3.0.0-alpha1
 */
class HealthcheckResponse {
    /**
     * Constructs a new <code>HealthcheckResponse</code>.
     * @alias module:models/HealthcheckResponse
     * @implements module:models/Healthcheck
     ...
     * @param {module:models/HealthcheckResponse} obj Optional instance to populate.
     * @return {module:models/HealthcheckResponse} The populated <code>HealthcheckResponse</code> instance.
     */
