...
class TlsCertificateData {
     ...
     * @param {module:models/TlsCertificateData} obj Optional instance to populate.
     * @return {module:models/TlsCertificateData} The populated <code>TlsCertificateData</code> instance.
     */
