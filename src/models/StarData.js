 ...
 * @module models/StarData
 * @version 3.0.0-alpha1
 */
class StarData {
    /**
     * Constructs a new <code>StarData</code>.
     * @alias module:models/StarData
     */
    constructor() { 
     ...
     * @param {module:models/StarData} obj Optional instance to populate.
     * @return {module:models/StarData} The populated <code>StarData</code> instance.
     */
