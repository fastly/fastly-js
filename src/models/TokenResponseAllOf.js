...
class TokenResponseAllOf {
     ...
     * @param {module:models/TokenResponseAllOf} obj Optional instance to populate.
     * @return {module:models/TokenResponseAllOf} The populated <code>TokenResponseAllOf</code> instance.
     */
