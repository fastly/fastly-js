...
class WafFirewallVersion {
     ...
     * @param {module:models/WafFirewallVersion} obj Optional instance to populate.
     * @return {module:models/WafFirewallVersion} The populated <code>WafFirewallVersion</code> instance.
     */
...
/**
 * @member {module:models/WafFirewallVersionData} data
 */
