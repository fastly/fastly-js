...
class SchemasVersion {
     ...
     * @param {module:models/SchemasVersion} obj Optional instance to populate.
     * @return {module:models/SchemasVersion} The populated <code>SchemasVersion</code> instance.
     */
