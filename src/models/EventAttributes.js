 ...
 * @module models/EventAttributes
 * @version 3.0.0-alpha1
 */
class EventAttributes {
    /**
     * Constructs a new <code>EventAttributes</code>.
     * @alias module:models/EventAttributes
     */
    constructor() { 
     ...
     * @param {module:models/EventAttributes} obj Optional instance to populate.
     * @return {module:models/EventAttributes} The populated <code>EventAttributes</code> instance.
     */
 ...
 * @member {module:models/EventAttributes.EventTypeEnum} event_type
 */
