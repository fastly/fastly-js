 ...
 * @module models/LoggingAzureblobResponse
 * @version 3.0.0-alpha1
 */
class LoggingAzureblobResponse {
    /**
     * Constructs a new <code>LoggingAzureblobResponse</code>.
     * @alias module:models/LoggingAzureblobResponse
     * @implements module:models/LoggingAzureblob
     ...
     * @param {module:models/LoggingAzureblobResponse} obj Optional instance to populate.
     * @return {module:models/LoggingAzureblobResponse} The populated <code>LoggingAzureblobResponse</code> instance.
     */
