...
class LoggingDatadogAllOf {
     ...
     * @param {module:models/LoggingDatadogAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingDatadogAllOf} The populated <code>LoggingDatadogAllOf</code> instance.
     */
