 ...
 * @module models/LoggingCommon
 * @version 3.0.0-alpha1
 */
class LoggingCommon {
    /**
     * Constructs a new <code>LoggingCommon</code>.
     * @alias module:models/LoggingCommon
     */
    constructor() { 
     ...
     * @param {module:models/LoggingCommon} obj Optional instance to populate.
     * @return {module:models/LoggingCommon} The populated <code>LoggingCommon</code> instance.
     */
