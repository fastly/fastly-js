...
class TlsPrivateKeyResponse {
     ...
     * @param {module:models/TlsPrivateKeyResponse} obj Optional instance to populate.
     * @return {module:models/TlsPrivateKeyResponse} The populated <code>TlsPrivateKeyResponse</code> instance.
     */
...
/**
 * @member {module:models/TlsPrivateKeyResponseData} data
 */
