...
class TlsCertificateResponse {
     ...
     * @param {module:models/TlsCertificateResponse} obj Optional instance to populate.
     * @return {module:models/TlsCertificateResponse} The populated <code>TlsCertificateResponse</code> instance.
     */
...
/**
 * @member {module:models/TlsCertificateResponseData} data
 */
