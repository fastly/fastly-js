 ...
 * @module models/ResponseObject
 * @version 3.0.0-alpha1
 */
class ResponseObject {
    /**
     * Constructs a new <code>ResponseObject</code>.
     * @alias module:models/ResponseObject
     */
    constructor() { 
     ...
     * @param {module:models/ResponseObject} obj Optional instance to populate.
     * @return {module:models/ResponseObject} The populated <code>ResponseObject</code> instance.
     */
