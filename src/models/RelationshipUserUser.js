...
class RelationshipUserUser {
     ...
     * @param {module:models/RelationshipUserUser} obj Optional instance to populate.
     * @return {module:models/RelationshipUserUser} The populated <code>RelationshipUserUser</code> instance.
     */
...
/**
 * @member {module:models/RelationshipUserUserData} data
 */
