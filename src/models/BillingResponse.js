 ...
 * @module models/BillingResponse
 * @version 3.0.0-alpha1
 */
class BillingResponse {
    /**
     * Constructs a new <code>BillingResponse</code>.
     * @alias module:models/BillingResponse
     * @implements module:models/Billing
     * @implements module:models/BillingResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/BillingResponse} obj Optional instance to populate.
     * @return {module:models/BillingResponse} The populated <code>BillingResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/Timestamps>} line_items
 */
