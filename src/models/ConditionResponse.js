 ...
 * @module models/ConditionResponse
 * @version 3.0.0-alpha1
 */
class ConditionResponse {
    /**
     * Constructs a new <code>ConditionResponse</code>.
     * @alias module:models/ConditionResponse
     * @implements module:models/Condition
     ...
     * @param {module:models/ConditionResponse} obj Optional instance to populate.
     * @return {module:models/ConditionResponse} The populated <code>ConditionResponse</code> instance.
     */
 ...
 * @member {module:models/ConditionResponse.TypeEnum} type
 */
...
/**
 * Type of the condition. Required.
 * @member {module:models/Condition.TypeEnum} type
 */
