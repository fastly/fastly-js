 ...
 * @module models/LoggingGcs
 * @version 3.0.0-alpha1
 */
class LoggingGcs {
    /**
     * Constructs a new <code>LoggingGcs</code>.
     * @alias module:models/LoggingGcs
     ...
     * @implements module:models/LoggingGcsAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingGcs} obj Optional instance to populate.
     * @return {module:models/LoggingGcs} The populated <code>LoggingGcs</code> instance.
     */
