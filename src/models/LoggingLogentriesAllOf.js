...
class LoggingLogentriesAllOf {
     ...
     * @param {module:models/LoggingLogentriesAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingLogentriesAllOf} The populated <code>LoggingLogentriesAllOf</code> instance.
     */
