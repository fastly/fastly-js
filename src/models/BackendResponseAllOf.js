...
class BackendResponseAllOf {
     ...
     * @param {module:models/BackendResponseAllOf} obj Optional instance to populate.
     * @return {module:models/BackendResponseAllOf} The populated <code>BackendResponseAllOf</code> instance.
     */
