...
class LoggingTlsCommon {
     ...
     * @param {module:models/LoggingTlsCommon} obj Optional instance to populate.
     * @return {module:models/LoggingTlsCommon} The populated <code>LoggingTlsCommon</code> instance.
     */
