 ...
 * @module models/HistoricalFieldResponse
 * @version 3.0.0-alpha1
 */
class HistoricalFieldResponse {
    /**
     * Constructs a new <code>HistoricalFieldResponse</code>.
     * @alias module:models/HistoricalFieldResponse
     * @implements module:models/Historical
     * @implements module:models/HistoricalFieldResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalFieldResponse} obj Optional instance to populate.
     * @return {module:models/HistoricalFieldResponse} The populated <code>HistoricalFieldResponse</code> instance.
     */
