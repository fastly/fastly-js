 ...
 * @module models/PackageResponse
 * @version 3.0.0-alpha1
 */
class PackageResponse {
    /**
     * Constructs a new <code>PackageResponse</code>.
     * @alias module:models/PackageResponse
     * @implements module:models/Package
     * @implements module:models/ServiceIdAndVersion
     * @implements module:models/Timestamps
     * @implements module:models/PackageResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/PackageResponse} obj Optional instance to populate.
     * @return {module:models/PackageResponse} The populated <code>PackageResponse</code> instance.
     */
...
/**
 * @member {module:models/PackageMetadata} metadata
 */
