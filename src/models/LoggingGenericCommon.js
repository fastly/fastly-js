...
class LoggingGenericCommon {
     ...
     * @param {module:models/LoggingGenericCommon} obj Optional instance to populate.
     * @return {module:models/LoggingGenericCommon} The populated <code>LoggingGenericCommon</code> instance.
     */
