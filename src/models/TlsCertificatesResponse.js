 ...
 * @module models/TlsCertificatesResponse
 * @version 3.0.0-alpha1
 */
class TlsCertificatesResponse {
    /**
     * Constructs a new <code>TlsCertificatesResponse</code>.
     * @alias module:models/TlsCertificatesResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsCertificatesResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsCertificatesResponse} obj Optional instance to populate.
     * @return {module:models/TlsCertificatesResponse} The populated <code>TlsCertificatesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsCertificateResponseData>} data
 */
