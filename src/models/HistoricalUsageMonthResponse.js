 ...
 * @module models/HistoricalUsageMonthResponse
 * @version 3.0.0-alpha1
 */
class HistoricalUsageMonthResponse {
    /**
     * Constructs a new <code>HistoricalUsageMonthResponse</code>.
     * @alias module:models/HistoricalUsageMonthResponse
     * @implements module:models/Historical
     * @implements module:models/HistoricalUsageMonthResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/HistoricalUsageMonthResponse} obj Optional instance to populate.
     * @return {module:models/HistoricalUsageMonthResponse} The populated <code>HistoricalUsageMonthResponse</code> instance.
     */
