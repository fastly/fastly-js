...
class LoggingKinesis {
     ...
     * @param {module:models/LoggingKinesis} obj Optional instance to populate.
     * @return {module:models/LoggingKinesis} The populated <code>LoggingKinesis</code> instance.
     */
