...
class LoggingAddressAndPort {
     ...
     * @param {module:models/LoggingAddressAndPort} obj Optional instance to populate.
     * @return {module:models/LoggingAddressAndPort} The populated <code>LoggingAddressAndPort</code> instance.
     */
