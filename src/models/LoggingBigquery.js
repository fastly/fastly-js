...
class LoggingBigquery {
     ...
     * @param {module:models/LoggingBigquery} obj Optional instance to populate.
     * @return {module:models/LoggingBigquery} The populated <code>LoggingBigquery</code> instance.
     */
