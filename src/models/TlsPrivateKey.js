 ...
 * @module models/TlsPrivateKey
 * @version 3.0.0-alpha1
 */
class TlsPrivateKey {
    /**
     * Constructs a new <code>TlsPrivateKey</code>.
     * @alias module:models/TlsPrivateKey
     */
    constructor() { 
     ...
     * @param {module:models/TlsPrivateKey} obj Optional instance to populate.
     * @return {module:models/TlsPrivateKey} The populated <code>TlsPrivateKey</code> instance.
     */
...
/**
 * @member {module:models/TlsPrivateKeyData} data
 */
