...
class ServiceInvitationDataAttributes {
     ...
     * @param {module:models/ServiceInvitationDataAttributes} obj Optional instance to populate.
     * @return {module:models/ServiceInvitationDataAttributes} The populated <code>ServiceInvitationDataAttributes</code> instance.
     */
 ...
 * @member {module:models/ServiceInvitationDataAttributes.PermissionEnum} permission
 * @default 'full'
 */
