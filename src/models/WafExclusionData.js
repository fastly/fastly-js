...
class WafExclusionData {
     ...
     * @param {module:models/WafExclusionData} obj Optional instance to populate.
     * @return {module:models/WafExclusionData} The populated <code>WafExclusionData</code> instance.
     */
