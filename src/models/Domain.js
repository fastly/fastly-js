...
class Domain {
     ...
     * @param {module:models/Domain} obj Optional instance to populate.
     * @return {module:models/Domain} The populated <code>Domain</code> instance.
     */
