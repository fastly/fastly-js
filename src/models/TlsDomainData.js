 ...
 * @module models/TlsDomainData
 * @version 3.0.0-alpha1
 */
class TlsDomainData {
    /**
     * Constructs a new <code>TlsDomainData</code>.
     * @alias module:models/TlsDomainData
     */
    constructor() { 
     ...
     * @param {module:models/TlsDomainData} obj Optional instance to populate.
     * @return {module:models/TlsDomainData} The populated <code>TlsDomainData</code> instance.
     */
...
/**
 * @member {module:models/RelationshipsForTlsDomain} relationships
 */
