...
class RelationshipWafRules {
     ...
     * @param {module:models/RelationshipWafRules} obj Optional instance to populate.
     * @return {module:models/RelationshipWafRules} The populated <code>RelationshipWafRules</code> instance.
     */
