 ...
 * @module models/LoggingSyslogResponse
 * @version 3.0.0-alpha1
 */
class LoggingSyslogResponse {
    /**
     * Constructs a new <code>LoggingSyslogResponse</code>.
     * @alias module:models/LoggingSyslogResponse
     * @implements module:models/LoggingSyslog
     ...
     * @param {module:models/LoggingSyslogResponse} obj Optional instance to populate.
     * @return {module:models/LoggingSyslogResponse} The populated <code>LoggingSyslogResponse</code> instance.
     */
