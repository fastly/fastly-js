 ...
 * @module models/TlsSubscriptionsResponse
 * @version 3.0.0-alpha1
 */
class TlsSubscriptionsResponse {
    /**
     * Constructs a new <code>TlsSubscriptionsResponse</code>.
     * @alias module:models/TlsSubscriptionsResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsSubscriptionsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsSubscriptionsResponse} obj Optional instance to populate.
     * @return {module:models/TlsSubscriptionsResponse} The populated <code>TlsSubscriptionsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsSubscriptionResponse>} data
 */
