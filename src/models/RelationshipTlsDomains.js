...
class RelationshipTlsDomains {
     ...
     * @param {module:models/RelationshipTlsDomains} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsDomains} The populated <code>RelationshipTlsDomains</code> instance.
     */
