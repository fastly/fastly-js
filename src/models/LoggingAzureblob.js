...
class LoggingAzureblob {
     ...
     * @param {module:models/LoggingAzureblob} obj Optional instance to populate.
     * @return {module:models/LoggingAzureblob} The populated <code>LoggingAzureblob</code> instance.
     */
