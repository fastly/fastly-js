...
class RelationshipWafTagsWafTags {
     ...
     * @param {module:models/RelationshipWafTagsWafTags} obj Optional instance to populate.
     * @return {module:models/RelationshipWafTagsWafTags} The populated <code>RelationshipWafTagsWafTags</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberWafTag>} data
 */
