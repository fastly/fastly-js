 ...
 * @module models/RequestSettings
 * @version 3.0.0-alpha1
 */
class RequestSettings {
    /**
     * Constructs a new <code>RequestSettings</code>.
     * @alias module:models/RequestSettings
     */
    constructor() { 
     ...
     * @param {module:models/RequestSettings} obj Optional instance to populate.
     * @return {module:models/RequestSettings} The populated <code>RequestSettings</code> instance.
     */
