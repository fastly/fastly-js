...
class LoggingLogshuttleAllOf {
     ...
     * @param {module:models/LoggingLogshuttleAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingLogshuttleAllOf} The populated <code>LoggingLogshuttleAllOf</code> instance.
     */
