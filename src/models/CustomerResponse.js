 ...
 * @module models/CustomerResponse
 * @version 3.0.0-alpha1
 */
class CustomerResponse {
    /**
     * Constructs a new <code>CustomerResponse</code>.
     * @alias module:models/CustomerResponse
     * @implements module:models/Customer
     * @implements module:models/Timestamps
     * @implements module:models/CustomerResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/CustomerResponse} obj Optional instance to populate.
     * @return {module:models/CustomerResponse} The populated <code>CustomerResponse</code> instance.
     */
 ...
 * @member {module:models/CustomerResponse.BillingNetworkTypeEnum} billing_network_type
 */
...
/**
 * Customer's current network revenue type.
 * @member {module:models/Customer.BillingNetworkTypeEnum} billing_network_type
 */
