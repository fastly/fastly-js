...
class ServiceResponseAllOf {
     ...
     * @param {module:models/ServiceResponseAllOf} obj Optional instance to populate.
     * @return {module:models/ServiceResponseAllOf} The populated <code>ServiceResponseAllOf</code> instance.
     */
