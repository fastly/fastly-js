 ...
 * @module models/TlsCertificateResponseData
 * @version 3.0.0-alpha1
 */
class TlsCertificateResponseData {
    /**
     * Constructs a new <code>TlsCertificateResponseData</code>.
     * @alias module:models/TlsCertificateResponseData
     * @implements module:models/TlsCertificateData
     * @implements module:models/TlsCertificateResponseDataAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsCertificateResponseData} obj Optional instance to populate.
     * @return {module:models/TlsCertificateResponseData} The populated <code>TlsCertificateResponseData</code> instance.
     */
