...
class TlsBulkCertificateData {
     ...
     * @param {module:models/TlsBulkCertificateData} obj Optional instance to populate.
     * @return {module:models/TlsBulkCertificateData} The populated <code>TlsBulkCertificateData</code> instance.
     */
