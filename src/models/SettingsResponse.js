 ...
 * @module models/SettingsResponse
 * @version 3.0.0-alpha1
 */
class SettingsResponse {
    /**
     * Constructs a new <code>SettingsResponse</code>.
     * @alias module:models/SettingsResponse
     * @implements module:models/Settings
     ...
     * @param {module:models/SettingsResponse} obj Optional instance to populate.
     * @return {module:models/SettingsResponse} The populated <code>SettingsResponse</code> instance.
     */
