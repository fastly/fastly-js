...
class EventsResponseAllOf {
     ...
     * @param {module:models/EventsResponseAllOf} obj Optional instance to populate.
     * @return {module:models/EventsResponseAllOf} The populated <code>EventsResponseAllOf</code> instance.
     */
