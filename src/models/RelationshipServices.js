...
class RelationshipServices {
     ...
     * @param {module:models/RelationshipServices} obj Optional instance to populate.
     * @return {module:models/RelationshipServices} The populated <code>RelationshipServices</code> instance.
     */
...
/**
 * @member {module:models/RelationshipServiceService} services
 */
