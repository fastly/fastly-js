...
class DictionaryInfoResponse {
     ...
     * @param {module:models/DictionaryInfoResponse} obj Optional instance to populate.
     * @return {module:models/DictionaryInfoResponse} The populated <code>DictionaryInfoResponse</code> instance.
     */
