 ...
 * @module models/WafExclusion
 * @version 3.0.0-alpha1
 */
class WafExclusion {
    /**
     * Constructs a new <code>WafExclusion</code>.
     * @alias module:models/WafExclusion
     */
    constructor() { 
     ...
     * @param {module:models/WafExclusion} obj Optional instance to populate.
     * @return {module:models/WafExclusion} The populated <code>WafExclusion</code> instance.
     */
...
/**
 * @member {module:models/WafExclusionData} data
 */
