...
class LoggingS3AllOf {
     ...
     * @param {module:models/LoggingS3AllOf} obj Optional instance to populate.
     * @return {module:models/LoggingS3AllOf} The populated <code>LoggingS3AllOf</code> instance.
     */
