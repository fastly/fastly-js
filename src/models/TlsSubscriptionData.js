...
class TlsSubscriptionData {
     ...
     * @param {module:models/TlsSubscriptionData} obj Optional instance to populate.
     * @return {module:models/TlsSubscriptionData} The populated <code>TlsSubscriptionData</code> instance.
     */
