 ...
 * @module models/TlsConfigurationsResponse
 * @version 3.0.0-alpha1
 */
class TlsConfigurationsResponse {
    /**
     * Constructs a new <code>TlsConfigurationsResponse</code>.
     * @alias module:models/TlsConfigurationsResponse
     * @implements module:models/Pagination
     * @implements module:models/TlsConfigurationsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsConfigurationsResponse} obj Optional instance to populate.
     * @return {module:models/TlsConfigurationsResponse} The populated <code>TlsConfigurationsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/TlsConfigurationResponseData>} data
 */
