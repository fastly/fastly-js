...
class WafRuleRevision {
     ...
     * @param {module:models/WafRuleRevision} obj Optional instance to populate.
     * @return {module:models/WafRuleRevision} The populated <code>WafRuleRevision</code> instance.
     */
