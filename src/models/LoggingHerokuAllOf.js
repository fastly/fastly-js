...
class LoggingHerokuAllOf {
     ...
     * @param {module:models/LoggingHerokuAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingHerokuAllOf} The populated <code>LoggingHerokuAllOf</code> instance.
     */
