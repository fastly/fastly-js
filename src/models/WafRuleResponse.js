...
class WafRuleResponse {
     ...
     * @param {module:models/WafRuleResponse} obj Optional instance to populate.
     * @return {module:models/WafRuleResponse} The populated <code>WafRuleResponse</code> instance.
     */
...
/**
 * @member {module:models/WafRuleResponseData} data
 */
