 ...
 * @module models/WafRule
 * @version 3.0.0-alpha1
 */
class WafRule {
    /**
     * Constructs a new <code>WafRule</code>.
     * @alias module:models/WafRule
     */
    constructor() { 
     ...
     * @param {module:models/WafRule} obj Optional instance to populate.
     * @return {module:models/WafRule} The populated <code>WafRule</code> instance.
     */
