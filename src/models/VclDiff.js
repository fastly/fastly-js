 ...
 * @module models/VclDiff
 * @version 3.0.0-alpha1
 */
class VclDiff {
    /**
     * Constructs a new <code>VclDiff</code>.
     * @alias module:models/VclDiff
     */
    constructor() { 
     ...
     * @param {module:models/VclDiff} obj Optional instance to populate.
     * @return {module:models/VclDiff} The populated <code>VclDiff</code> instance.
     */
 ...
 * @member {module:models/VclDiff.FormatEnum} format
 */
