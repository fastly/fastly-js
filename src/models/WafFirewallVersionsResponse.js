 ...
 * @module models/WafFirewallVersionsResponse
 * @version 3.0.0-alpha1
 */
class WafFirewallVersionsResponse {
    /**
     * Constructs a new <code>WafFirewallVersionsResponse</code>.
     * @alias module:models/WafFirewallVersionsResponse
     * @implements module:models/Pagination
     * @implements module:models/WafFirewallVersionsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafFirewallVersionsResponse} obj Optional instance to populate.
     * @return {module:models/WafFirewallVersionsResponse} The populated <code>WafFirewallVersionsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafFirewallVersionResponseData>} data
 */
WafFirewallVersionsResponse.prototype['data'] = undefined;

/**
 * @member {Array.<module:models/IncludedWithWafFirewallVersionItem>} included
 */
