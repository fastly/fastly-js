...
class SchemasDirector {
     ...
     * @param {module:models/SchemasDirector} obj Optional instance to populate.
     * @return {module:models/SchemasDirector} The populated <code>SchemasDirector</code> instance.
     */
 ...
 * @member {Array.<module:models/Backend>} backends
 */
 ...
 * @member {module:models/SchemasDirector.TypeEnum} type
