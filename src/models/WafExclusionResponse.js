...
class WafExclusionResponse {
     ...
     * @param {module:models/WafExclusionResponse} obj Optional instance to populate.
     * @return {module:models/WafExclusionResponse} The populated <code>WafExclusionResponse</code> instance.
     */
...
/**
 * @member {module:models/WafExclusionResponseData} data
 */
