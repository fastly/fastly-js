 ...
 * @module models/LoggingKinesisResponse
 * @version 3.0.0-alpha1
 */
class LoggingKinesisResponse {
    /**
     * Constructs a new <code>LoggingKinesisResponse</code>.
     * @alias module:models/LoggingKinesisResponse
     * @implements module:models/LoggingKinesis
     ...
     * @param {module:models/LoggingKinesisResponse} obj Optional instance to populate.
     * @return {module:models/LoggingKinesisResponse} The populated <code>LoggingKinesisResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingKinesisResponse.RegionEnum} region
 */
