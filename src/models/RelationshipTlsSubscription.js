...
class RelationshipTlsSubscription {
     ...
     * @param {module:models/RelationshipTlsSubscription} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsSubscription} The populated <code>RelationshipTlsSubscription</code> instance.
     */
...
/**
 * @member {module:models/RelationshipTlsSubscriptionTlsSubscription} tls_subscription
 */
