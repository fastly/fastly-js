...
class WafFirewallVersionResponse {
     ...
     * @param {module:models/WafFirewallVersionResponse} obj Optional instance to populate.
     * @return {module:models/WafFirewallVersionResponse} The populated <code>WafFirewallVersionResponse</code> instance.
     */
...
/**
 * @member {module:models/WafFirewallVersionResponseData} data
 */
