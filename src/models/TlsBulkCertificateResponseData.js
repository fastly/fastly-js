 ...
 * @module models/TlsBulkCertificateResponseData
 * @version 3.0.0-alpha1
 */
class TlsBulkCertificateResponseData {
    /**
     * Constructs a new <code>TlsBulkCertificateResponseData</code>.
     * @alias module:models/TlsBulkCertificateResponseData
     * @implements module:models/TlsBulkCertificateData
     * @implements module:models/TlsBulkCertificateResponseDataAllOf
     */
    constructor() { 
     ...
     * @param {module:models/TlsBulkCertificateResponseData} obj Optional instance to populate.
     * @return {module:models/TlsBulkCertificateResponseData} The populated <code>TlsBulkCertificateResponseData</code> instance.
     */
