 ...
 * @module models/ResponseObjectResponse
 * @version 3.0.0-alpha1
 */
class ResponseObjectResponse {
    /**
     * Constructs a new <code>ResponseObjectResponse</code>.
     * @alias module:models/ResponseObjectResponse
     * @implements module:models/ResponseObject
     ...
     * @param {module:models/ResponseObjectResponse} obj Optional instance to populate.
     * @return {module:models/ResponseObjectResponse} The populated <code>ResponseObjectResponse</code> instance.
     */
