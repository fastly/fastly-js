 ...
 * @module models/WafRulesResponse
 * @version 3.0.0-alpha1
 */
class WafRulesResponse {
    /**
     * Constructs a new <code>WafRulesResponse</code>.
     * @alias module:models/WafRulesResponse
     * @implements module:models/Pagination
     * @implements module:models/WafRulesResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafRulesResponse} obj Optional instance to populate.
     * @return {module:models/WafRulesResponse} The populated <code>WafRulesResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafRuleResponseData>} data
 */
WafRulesResponse.prototype['data'] = undefined;

/**
 * @member {Array.<module:models/IncludedWithWafRuleItem>} included
 */
