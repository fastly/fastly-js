 ...
 * @module models/AclEntryResponse
 * @version 3.0.0-alpha1
 */
class AclEntryResponse {
    /**
     * Constructs a new <code>AclEntryResponse</code>.
     * @alias module:models/AclEntryResponse
     * @implements module:models/AclEntry
     * @implements module:models/Timestamps
     * @implements module:models/AclEntryResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/AclEntryResponse} obj Optional instance to populate.
     * @return {module:models/AclEntryResponse} The populated <code>AclEntryResponse</code> instance.
     */
 ...
 * @member {module:models/AclEntryResponse.NegatedEnum} negated
