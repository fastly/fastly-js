...
class LoggingGcsCommon {
     ...
     * @param {module:models/LoggingGcsCommon} obj Optional instance to populate.
     * @return {module:models/LoggingGcsCommon} The populated <code>LoggingGcsCommon</code> instance.
     */
