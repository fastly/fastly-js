 ...
 * @module models/ServiceListResponse
 * @version 3.0.0-alpha1
 */
class ServiceListResponse {
    /**
     * Constructs a new <code>ServiceListResponse</code>.
     * @alias module:models/ServiceListResponse
     * @implements module:models/Timestamps
     * @implements module:models/ServiceCreate
     * @implements module:models/ServiceListResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/ServiceListResponse} obj Optional instance to populate.
     * @return {module:models/ServiceListResponse} The populated <code>ServiceListResponse</code> instance.
     */
 ...
 * @member {module:models/ServiceListResponse.TypeEnum} type
 */
...
/**
 * The type of this service.
 * @member {module:models/ServiceCreate.TypeEnum} type
 */
