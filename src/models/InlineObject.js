 ...
 * @module models/InlineObject
 * @version 3.0.0-alpha1
 */
class InlineObject {
    /**
     * Constructs a new <code>InlineObject</code>.
     * @alias module:models/InlineObject
     */
    constructor() { 
     ...
     * @param {module:models/InlineObject} obj Optional instance to populate.
     * @return {module:models/InlineObject} The populated <code>InlineObject</code> instance.
     */
...
/**
 * @member {module:models/CustomerCustomerIdBillingAddressData} data
 */
