...
class RelationshipCommonName {
     ...
     * @param {module:models/RelationshipCommonName} obj Optional instance to populate.
     * @return {module:models/RelationshipCommonName} The populated <code>RelationshipCommonName</code> instance.
     */
...
/**
 * @member {module:models/RelationshipCommonNameCommonName} common_name
 */
