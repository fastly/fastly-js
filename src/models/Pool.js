...
class Pool {
     ...
     * @alias module:models/Pool
     * @implements module:models/TlsCommon
     * @implements module:models/PoolAllOf
     */
    constructor() { 
     ...
     * @param {module:models/Pool} obj Optional instance to populate.
     * @return {module:models/Pool} The populated <code>Pool</code> instance.
     */
...
/**
 * Whether to use TLS.
 * @member {module:models/TlsCommon.UseTlsEnum} use_tls
 * @default UseTlsEnum.no_tls
 */
...
/**
 * What type of load balance group to use.
 * @member {module:models/PoolAllOf.TypeEnum} type
 */
