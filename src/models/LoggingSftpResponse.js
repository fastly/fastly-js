 ...
 * @module models/LoggingSftpResponse
 * @version 3.0.0-alpha1
 */
class LoggingSftpResponse {
    /**
     * Constructs a new <code>LoggingSftpResponse</code>.
     * @alias module:models/LoggingSftpResponse
     * @implements module:models/LoggingSftp
     ...
     * @param {module:models/LoggingSftpResponse} obj Optional instance to populate.
     * @return {module:models/LoggingSftpResponse} The populated <code>LoggingSftpResponse</code> instance.
     */
