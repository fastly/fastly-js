 ...
 * @module models/Historical
 * @version 3.0.0-alpha1
 */
class Historical {
    /**
     * Constructs a new <code>Historical</code>.
     * @alias module:models/Historical
     */
    constructor() { 
     ...
     * @param {module:models/Historical} obj Optional instance to populate.
     * @return {module:models/Historical} The populated <code>Historical</code> instance.
     */
