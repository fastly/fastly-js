...
class TlsActivationResponse {
     ...
     * @param {module:models/TlsActivationResponse} obj Optional instance to populate.
     * @return {module:models/TlsActivationResponse} The populated <code>TlsActivationResponse</code> instance.
     */
...
/**
 * @member {module:models/TlsActivationResponseData} data
 */
