 ...
 * @module models/RelationshipsForInvitation
 * @version 3.0.0-alpha1
 */
class RelationshipsForInvitation {
    /**
     * Constructs a new <code>RelationshipsForInvitation</code>.
     * @alias module:models/RelationshipsForInvitation
     * @implements module:models/RelationshipCustomer
     * @implements module:models/RelationshipServiceInvitations
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipsForInvitation} obj Optional instance to populate.
     * @return {module:models/RelationshipsForInvitation} The populated <code>RelationshipsForInvitation</code> instance.
     */
...
/**
 * @member {module:models/RelationshipCustomerCustomer} customer
 */
RelationshipsForInvitation.prototype['customer'] = undefined;

/**
 * @member {module:models/RelationshipServiceInvitationsServiceInvitations} service_invitations
 */
