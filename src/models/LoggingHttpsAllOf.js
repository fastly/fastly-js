...
class LoggingHttpsAllOf {
     ...
     * @param {module:models/LoggingHttpsAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingHttpsAllOf} The populated <code>LoggingHttpsAllOf</code> instance.
     */
