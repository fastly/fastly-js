...
class Stats {
     ...
     * @param {module:models/Stats} obj Optional instance to populate.
     * @return {module:models/Stats} The populated <code>Stats</code> instance.
     */
...
/**
 * @member {Object.<String, module:models/Results>} stats
 */
