 ...
 * @module models/LoggingSyslog
 * @version 3.0.0-alpha1
 */
class LoggingSyslog {
    /**
     * Constructs a new <code>LoggingSyslog</code>.
     * @alias module:models/LoggingSyslog
     ...
     * @implements module:models/LoggingSyslogAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingSyslog} obj Optional instance to populate.
     * @return {module:models/LoggingSyslog} The populated <code>LoggingSyslog</code> instance.
     */
