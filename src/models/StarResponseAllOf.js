...
class StarResponseAllOf {
     ...
     * @param {module:models/StarResponseAllOf} obj Optional instance to populate.
     * @return {module:models/StarResponseAllOf} The populated <code>StarResponseAllOf</code> instance.
     */
