 ...
 * @module models/LoggingGooglePubsubResponse
 * @version 3.0.0-alpha1
 */
class LoggingGooglePubsubResponse {
    /**
     * Constructs a new <code>LoggingGooglePubsubResponse</code>.
     * @alias module:models/LoggingGooglePubsubResponse
     * @implements module:models/LoggingGooglePubsub
     ...
     * @param {module:models/LoggingGooglePubsubResponse} obj Optional instance to populate.
     * @return {module:models/LoggingGooglePubsubResponse} The populated <code>LoggingGooglePubsubResponse</code> instance.
     */
 ...
 * @member {module:models/LoggingGooglePubsubResponse.FormatVersionEnum} format_version
 ...
 * @member {module:models/LoggingGooglePubsubResponse.PlacementEnum} placement
 */
...
/**
 * The version of the custom logging format used for the configured endpoint. The logging call gets placed by default in `vcl_log` if `format_version` is set to `2` and in `vcl_deliver` if `format_version` is set to `1`.  
 * @member {module:models/LoggingGooglePubsub.FormatVersionEnum} format_version
 * @default FormatVersionEnum.v2
 */
...
/**
 * Where in the generated VCL the logging call should be placed. If not set, endpoints with `format_version` of 2 are placed in `vcl_log` and those with `format_version` of 1 are placed in `vcl_deliver`. 
 * @member {module:models/LoggingGooglePubsub.PlacementEnum} placement
 */
