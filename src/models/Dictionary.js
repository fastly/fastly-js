...
class Dictionary {
     ...
     * @alias module:models/Dictionary
     */
    constructor() { 
     ...
     * @param {module:models/Dictionary} obj Optional instance to populate.
     * @return {module:models/Dictionary} The populated <code>Dictionary</code> instance.
     */
