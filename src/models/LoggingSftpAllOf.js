...
class LoggingSftpAllOf {
     ...
     * @param {module:models/LoggingSftpAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingSftpAllOf} The populated <code>LoggingSftpAllOf</code> instance.
     */
