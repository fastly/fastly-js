...
class Billing {
     ...
     * @param {module:models/Billing} obj Optional instance to populate.
     * @return {module:models/Billing} The populated <code>Billing</code> instance.
     */
