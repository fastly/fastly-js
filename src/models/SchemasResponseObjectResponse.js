 ...
 * @module models/SchemasResponseObjectResponse
 * @version 3.0.0-alpha1
 */
class SchemasResponseObjectResponse {
    /**
     * Constructs a new <code>SchemasResponseObjectResponse</code>.
     * @alias module:models/SchemasResponseObjectResponse
     * @implements module:models/SchemasResponseObject
     ...
     * @param {module:models/SchemasResponseObjectResponse} obj Optional instance to populate.
     * @return {module:models/SchemasResponseObjectResponse} The populated <code>SchemasResponseObjectResponse</code> instance.
     */
...
export default SchemasResponseObjectResponse;
