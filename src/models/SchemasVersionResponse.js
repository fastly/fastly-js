 ...
 * @module models/SchemasVersionResponse
 * @version 3.0.0-alpha1
 */
class SchemasVersionResponse {
    /**
     * Constructs a new <code>SchemasVersionResponse</code>.
     * @alias module:models/SchemasVersionResponse
     * @implements module:models/SchemasVersion
     * @implements module:models/Timestamps
     * @implements module:models/SchemasVersionResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/SchemasVersionResponse} obj Optional instance to populate.
     * @return {module:models/SchemasVersionResponse} The populated <code>SchemasVersionResponse</code> instance.
     */
