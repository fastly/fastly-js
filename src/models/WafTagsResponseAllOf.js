...
class WafTagsResponseAllOf {
     ...
     * @param {module:models/WafTagsResponseAllOf} obj Optional instance to populate.
     * @return {module:models/WafTagsResponseAllOf} The populated <code>WafTagsResponseAllOf</code> instance.
     */
