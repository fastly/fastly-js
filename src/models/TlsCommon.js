 ...
 * @module models/TlsCommon
 * @version 3.0.0-alpha1
 */
class TlsCommon {
    /**
     * Constructs a new <code>TlsCommon</code>.
     * @alias module:models/TlsCommon
     */
    constructor() { 
     ...
     * @param {module:models/TlsCommon} obj Optional instance to populate.
     * @return {module:models/TlsCommon} The populated <code>TlsCommon</code> instance.
     */
