...
class LoggingNewrelicAllOf {
     ...
     * @param {module:models/LoggingNewrelicAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingNewrelicAllOf} The populated <code>LoggingNewrelicAllOf</code> instance.
     */
