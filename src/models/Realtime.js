 ...
 * @module models/Realtime
 * @version 3.0.0-alpha1
 */
class Realtime {
    /**
     * Constructs a new <code>Realtime</code>.
     * @alias module:models/Realtime
     */
    constructor() { 
     ...
     * @param {module:models/Realtime} obj Optional instance to populate.
     * @return {module:models/Realtime} The populated <code>Realtime</code> instance.
     */
 ...
 * @member {Array.<module:models/RealtimeEntry>} Data
 */
