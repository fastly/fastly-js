...
class RelationshipMemberWafRule {
     ...
     * @param {module:models/RelationshipMemberWafRule} obj Optional instance to populate.
     * @return {module:models/RelationshipMemberWafRule} The populated <code>RelationshipMemberWafRule</code> instance.
     */
