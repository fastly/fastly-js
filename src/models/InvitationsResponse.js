 ...
 * @module models/InvitationsResponse
 * @version 3.0.0-alpha1
 */
class InvitationsResponse {
    /**
     * Constructs a new <code>InvitationsResponse</code>.
     * @alias module:models/InvitationsResponse
     * @implements module:models/Pagination
     * @implements module:models/InvitationsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/InvitationsResponse} obj Optional instance to populate.
     * @return {module:models/InvitationsResponse} The populated <code>InvitationsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/InvitationResponseData>} data
 */
