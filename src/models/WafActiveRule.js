 ...
 * @module models/WafActiveRule
 * @version 3.0.0-alpha1
 */
class WafActiveRule {
    /**
     * Constructs a new <code>WafActiveRule</code>.
     * @alias module:models/WafActiveRule
     */
    constructor() { 
     ...
     * @param {module:models/WafActiveRule} obj Optional instance to populate.
     * @return {module:models/WafActiveRule} The populated <code>WafActiveRule</code> instance.
     */
