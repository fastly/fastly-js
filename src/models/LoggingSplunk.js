 ...
 * @module models/LoggingSplunk
 * @version 3.0.0-alpha1
 */
class LoggingSplunk {
    /**
     * Constructs a new <code>LoggingSplunk</code>.
     * @alias module:models/LoggingSplunk
     ...
     * @implements module:models/LoggingSplunkAllOf
     */
    constructor() { 
     ...
     * @param {module:models/LoggingSplunk} obj Optional instance to populate.
     * @return {module:models/LoggingSplunk} The populated <code>LoggingSplunk</code> instance.
     */
