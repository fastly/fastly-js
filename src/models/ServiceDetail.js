 ...
 * @module models/ServiceDetail
 * @version 3.0.0-alpha1
 */
class ServiceDetail {
    /**
     * Constructs a new <code>ServiceDetail</code>.
     * @alias module:models/ServiceDetail
     * @implements module:models/ServiceResponse
     * @implements module:models/ServiceDetailAllOf
     */
    constructor() { 
     ...
     * @param {module:models/ServiceDetail} obj Optional instance to populate.
     * @return {module:models/ServiceDetail} The populated <code>ServiceDetail</code> instance.
     */
 ...
 * @member {module:models/ServiceDetail.TypeEnum} type
 */
