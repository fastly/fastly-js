 ...
 * @module models/WafExclusionsResponse
 * @version 3.0.0-alpha1
 */
class WafExclusionsResponse {
    /**
     * Constructs a new <code>WafExclusionsResponse</code>.
     * @alias module:models/WafExclusionsResponse
     * @implements module:models/Pagination
     * @implements module:models/WafExclusionsResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/WafExclusionsResponse} obj Optional instance to populate.
     * @return {module:models/WafExclusionsResponse} The populated <code>WafExclusionsResponse</code> instance.
     */
...
/**
 * @member {Array.<module:models/WafExclusionResponseData>} data
 */
WafExclusionsResponse.prototype['data'] = undefined;

/**
 * @member {Array.<module:models/IncludedWithWafExclusionItem>} included
 */
