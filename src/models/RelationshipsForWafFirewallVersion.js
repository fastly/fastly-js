 ...
 * @module models/RelationshipsForWafFirewallVersion
 * @version 3.0.0-alpha1
 */
class RelationshipsForWafFirewallVersion {
    /**
     * Constructs a new <code>RelationshipsForWafFirewallVersion</code>.
     * @alias module:models/RelationshipsForWafFirewallVersion
     * @implements module:models/RelationshipWafFirewallVersions
     * @implements module:models/RelationshipWafActiveRules
     */
    constructor() { 
     ...
     * @param {module:models/RelationshipsForWafFirewallVersion} obj Optional instance to populate.
     * @return {module:models/RelationshipsForWafFirewallVersion} The populated <code>RelationshipsForWafFirewallVersion</code> instance.
     */
...
/**
 * @member {module:models/RelationshipWafFirewallVersionWafFirewallVersion} waf_firewall_versions
 */
RelationshipsForWafFirewallVersion.prototype['waf_firewall_versions'] = undefined;

/**
 * @member {module:models/RelationshipWafActiveRulesWafActiveRules} waf_active_rules
 */
