...
class DomainCheckItem {
     ...
     * @param {module:models/DomainCheckItem} obj Optional instance to populate.
     * @return {module:models/DomainCheckItem} The populated <code>DomainCheckItem</code> instance.
     */
