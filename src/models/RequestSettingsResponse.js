 ...
 * @module models/RequestSettingsResponse
 * @version 3.0.0-alpha1
 */
class RequestSettingsResponse {
    /**
     * Constructs a new <code>RequestSettingsResponse</code>.
     * @alias module:models/RequestSettingsResponse
     * @implements module:models/RequestSettings
     ...
     * @param {module:models/RequestSettingsResponse} obj Optional instance to populate.
     * @return {module:models/RequestSettingsResponse} The populated <code>RequestSettingsResponse</code> instance.
     */
 ...
 * @member {module:models/RequestSettingsResponse.ActionEnum} action
 */
 ...
 * @member {module:models/RequestSettingsResponse.XffEnum} xff
 */
...
/**
 * Allows you to terminate request handling and immediately perform an action.
 * @member {module:models/RequestSettings.ActionEnum} action
 */
...
/**
 * Short for X-Forwarded-For.
 * @member {module:models/RequestSettings.XffEnum} xff
 */
