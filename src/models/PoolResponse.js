 ...
 * @module models/PoolResponse
 * @version 3.0.0-alpha1
 */
class PoolResponse {
    /**
     * Constructs a new <code>PoolResponse</code>.
     * @alias module:models/PoolResponse
     * @implements module:models/Pool
     * @implements module:models/Timestamps
     * @implements module:models/ServiceIdAndVersion
     * @implements module:models/PoolResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/PoolResponse} obj Optional instance to populate.
     * @return {module:models/PoolResponse} The populated <code>PoolResponse</code> instance.
     */
...
/**
 * Whether to use TLS.
 * @member {module:models/PoolResponse.UseTlsEnum} use_tls
 ...
 * @member {module:models/PoolResponse.TypeEnum} type
 */
...
/**
 * Whether to use TLS.
 * @member {module:models/Pool.UseTlsEnum} use_tls
 * @default UseTlsEnum.no_tls
 */
...
/**
 * What type of load balance group to use.
 * @member {module:models/Pool.TypeEnum} type
 */
