...
class LoggingLogglyAllOf {
     ...
     * @param {module:models/LoggingLogglyAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingLogglyAllOf} The populated <code>LoggingLogglyAllOf</code> instance.
     */
