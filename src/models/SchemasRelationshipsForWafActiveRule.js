 ...
 * @module models/SchemasRelationshipsForWafActiveRule
 * @version 3.0.0-alpha1
 */
class SchemasRelationshipsForWafActiveRule {
    /**
     * Constructs a new <code>SchemasRelationshipsForWafActiveRule</code>.
     * @alias module:models/SchemasRelationshipsForWafActiveRule
     * @implements module:models/RelationshipWafFirewallVersion
     * @implements module:models/RelationshipWafRuleRevision
     */
    constructor() { 
     ...
     * @param {module:models/SchemasRelationshipsForWafActiveRule} obj Optional instance to populate.
     * @return {module:models/SchemasRelationshipsForWafActiveRule} The populated <code>SchemasRelationshipsForWafActiveRule</code> instance.
     */
...
/**
 * @member {module:models/RelationshipWafFirewallVersionWafFirewallVersion} waf_firewall_version
 */
SchemasRelationshipsForWafActiveRule.prototype['waf_firewall_version'] = undefined;

/**
 * @member {module:models/RelationshipWafRuleRevisionWafRuleRevisions} waf_rule_revisions
 */
