...
class RelationshipUserUserData {
     ...
     * @param {module:models/RelationshipUserUserData} obj Optional instance to populate.
     * @return {module:models/RelationshipUserUserData} The populated <code>RelationshipUserUserData</code> instance.
     */
...
/**
 * @member {module:models/TypeUser} type
 */
