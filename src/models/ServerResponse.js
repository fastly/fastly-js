 ...
 * @module models/ServerResponse
 * @version 3.0.0-alpha1
 */
class ServerResponse {
    /**
     * Constructs a new <code>ServerResponse</code>.
     * @alias module:models/ServerResponse
     * @implements module:models/Server
     * @implements module:models/Timestamps
     * @implements module:models/ServerResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/ServerResponse} obj Optional instance to populate.
     * @return {module:models/ServerResponse} The populated <code>ServerResponse</code> instance.
     */
