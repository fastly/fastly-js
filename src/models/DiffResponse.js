 ...
 * @module models/DiffResponse
 * @version 3.0.0-alpha1
 */
class DiffResponse {
    /**
     * Constructs a new <code>DiffResponse</code>.
     * @alias module:models/DiffResponse
     */
    constructor() { 
     ...
     * @param {module:models/DiffResponse} obj Optional instance to populate.
     * @return {module:models/DiffResponse} The populated <code>DiffResponse</code> instance.
     */
