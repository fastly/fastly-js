 ...
 * @module models/AclResponse
 * @version 3.0.0-alpha1
 */
class AclResponse {
    /**
     * Constructs a new <code>AclResponse</code>.
     * @alias module:models/AclResponse
     * @implements module:models/Acl
     * @implements module:models/Timestamps
     * @implements module:models/ServiceIdAndVersion
     * @implements module:models/AclResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/AclResponse} obj Optional instance to populate.
     * @return {module:models/AclResponse} The populated <code>AclResponse</code> instance.
     */
