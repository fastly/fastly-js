 ...
 * @module models/BillingAddressResponse
 * @version 3.0.0-alpha1
 */
class BillingAddressResponse {
    /**
     * Constructs a new <code>BillingAddressResponse</code>.
     * @alias module:models/BillingAddressResponse
     * @implements module:models/BillingAddress
     * @implements module:models/BillingAddressResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/BillingAddressResponse} obj Optional instance to populate.
     * @return {module:models/BillingAddressResponse} The populated <code>BillingAddressResponse</code> instance.
     */
...
/**
 * @member {module:models/BillingAddressData} data
 */
