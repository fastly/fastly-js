 ...
 * @module models/TlsCertificate
 * @version 3.0.0-alpha1
 */
class TlsCertificate {
    /**
     * Constructs a new <code>TlsCertificate</code>.
     * @alias module:models/TlsCertificate
     */
    constructor() { 
     ...
     * @param {module:models/TlsCertificate} obj Optional instance to populate.
     * @return {module:models/TlsCertificate} The populated <code>TlsCertificate</code> instance.
     */
...
/**
 * @member {module:models/TlsCertificateData} data
 */
