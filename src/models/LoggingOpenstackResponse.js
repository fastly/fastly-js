 ...
 * @module models/LoggingOpenstackResponse
 * @version 3.0.0-alpha1
 */
class LoggingOpenstackResponse {
    /**
     * Constructs a new <code>LoggingOpenstackResponse</code>.
     * @alias module:models/LoggingOpenstackResponse
     * @implements module:models/LoggingOpenstack
     ...
     * @param {module:models/LoggingOpenstackResponse} obj Optional instance to populate.
     * @return {module:models/LoggingOpenstackResponse} The populated <code>LoggingOpenstackResponse</code> instance.
     */
