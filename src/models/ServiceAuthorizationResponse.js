...
class ServiceAuthorizationResponse {
     ...
     * @param {module:models/ServiceAuthorizationResponse} obj Optional instance to populate.
     * @return {module:models/ServiceAuthorizationResponse} The populated <code>ServiceAuthorizationResponse</code> instance.
     */
...
/**
 * @member {module:models/ServiceAuthorizationResponseData} data
 */
