...
class RelationshipCustomer {
     ...
     * @param {module:models/RelationshipCustomer} obj Optional instance to populate.
     * @return {module:models/RelationshipCustomer} The populated <code>RelationshipCustomer</code> instance.
     */
