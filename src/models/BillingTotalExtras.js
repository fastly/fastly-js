...
class BillingTotalExtras {
     ...
     * @param {module:models/BillingTotalExtras} obj Optional instance to populate.
     * @return {module:models/BillingTotalExtras} The populated <code>BillingTotalExtras</code> instance.
     */
