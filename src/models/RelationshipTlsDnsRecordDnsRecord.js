...
class RelationshipTlsDnsRecordDnsRecord {
     ...
     * @param {module:models/RelationshipTlsDnsRecordDnsRecord} obj Optional instance to populate.
     * @return {module:models/RelationshipTlsDnsRecordDnsRecord} The populated <code>RelationshipTlsDnsRecordDnsRecord</code> instance.
     */
...
/**
 * @member {Array.<module:models/RelationshipMemberTlsDnsRecord>} data
 */
