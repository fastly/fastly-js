 ...
 * @module models/ServiceAuthorizationsData
 * @version 3.0.0-alpha1
 */
class ServiceAuthorizationsData {
    /**
     * Constructs a new <code>ServiceAuthorizationsData</code>.
     * @alias module:models/ServiceAuthorizationsData
     */
    constructor() { 
     ...
     * @param {module:models/ServiceAuthorizationsData} obj Optional instance to populate.
     * @return {module:models/ServiceAuthorizationsData} The populated <code>ServiceAuthorizationsData</code> instance.
     */
...
export default ServiceAuthorizationsData;
