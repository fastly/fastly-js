 ...
 * @module models/InvitationData
 * @version 3.0.0-alpha1
 */
class InvitationData {
    /**
     * Constructs a new <code>InvitationData</code>.
     * @alias module:models/InvitationData
     */
    constructor() { 
     ...
     * @param {module:models/InvitationData} obj Optional instance to populate.
     * @return {module:models/InvitationData} The populated <code>InvitationData</code> instance.
     */
