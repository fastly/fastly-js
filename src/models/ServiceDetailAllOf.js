...
class ServiceDetailAllOf {
     ...
     * @param {module:models/ServiceDetailAllOf} obj Optional instance to populate.
     * @return {module:models/ServiceDetailAllOf} The populated <code>ServiceDetailAllOf</code> instance.
     */
