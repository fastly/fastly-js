 ...
 * @module models/VersionResponse
 * @version 3.0.0-alpha1
 */
class VersionResponse {
    /**
     * Constructs a new <code>VersionResponse</code>.
     * @alias module:models/VersionResponse
     * @implements module:models/Version
     ...
     * @param {module:models/VersionResponse} obj Optional instance to populate.
     * @return {module:models/VersionResponse} The populated <code>VersionResponse</code> instance.
     */
