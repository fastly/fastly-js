...
class LoggingCloudfilesAllOf {
     ...
     * @param {module:models/LoggingCloudfilesAllOf} obj Optional instance to populate.
     * @return {module:models/LoggingCloudfilesAllOf} The populated <code>LoggingCloudfilesAllOf</code> instance.
     */
