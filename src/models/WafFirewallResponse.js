...
class WafFirewallResponse {
     ...
     * @param {module:models/WafFirewallResponse} obj Optional instance to populate.
     * @return {module:models/WafFirewallResponse} The populated <code>WafFirewallResponse</code> instance.
     */
...
/**
 * @member {module:models/WafFirewallResponseData} data
 */
