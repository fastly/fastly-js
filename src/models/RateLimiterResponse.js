 ...
 * @module models/RateLimiterResponse
 * @version 3.0.0-alpha1
 */
class RateLimiterResponse {
    /**
     * Constructs a new <code>RateLimiterResponse</code>.
     * @alias module:models/RateLimiterResponse
     * @implements module:models/RateLimiter
     * @implements module:models/ServiceIdAndVersion
     * @implements module:models/Timestamps
     * @implements module:models/RateLimiterResponseAllOf
     */
    constructor() { 
     ...
     * @param {module:models/RateLimiterResponse} obj Optional instance to populate.
     * @return {module:models/RateLimiterResponse} The populated <code>RateLimiterResponse</code> instance.
     */
 ...
 * @member {Array.<module:models/RateLimiterResponse.HttpMethodsEnum>} http_methods
 */
