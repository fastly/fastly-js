...
class LoggingFtp {
     ...
     * @param {module:models/LoggingFtp} obj Optional instance to populate.
     * @return {module:models/LoggingFtp} The populated <code>LoggingFtp</code> instance.
     */
