...
class LoggingCommonResponseAllOf {
    /**
     * Constructs a new <code>LoggingCommonResponseAllOf</code>.
    ...
    /**
     * Constructs a <code>LoggingCommonResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingCommonResponseAllOf} obj Optional instance to populate.
     * @return {module:model/LoggingCommonResponseAllOf} The populated <code>LoggingCommonResponseAllOf</code> instance.
     */
