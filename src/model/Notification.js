...
class Notification {
     ...
     * @param type {module:model/Notification.TypeEnum} Notification type
     * @param config {module:model/NotificationConfig} 
     */
    constructor(type, config) { 
        
        Notification.initialize(this, type, config);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('config')) {
                obj['config'] = NotificationConfig.constructFromObject(data['config']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/NotificationConfig} config
 */
Notification.prototype['config'] = undefined;
