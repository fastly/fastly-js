...
class DimensionDevice {
    /**
     * Constructs a new <code>DimensionDevice</code>.
    ...
    /**
     * Constructs a <code>DimensionDevice</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DimensionDevice} obj Optional instance to populate.
     * @return {module:model/DimensionDevice} The populated <code>DimensionDevice</code> instance.
     */
