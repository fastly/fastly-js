...
class HistoricalDomainsData {
    /**
     * Constructs a new <code>HistoricalDomainsData</code>.
     * @alias module:model/HistoricalDomainsData
     */
    constructor() { 
        
        HistoricalDomainsData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>HistoricalDomainsData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/HistoricalDomainsData} obj Optional instance to populate.
     * @return {module:model/HistoricalDomainsData} The populated <code>HistoricalDomainsData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new HistoricalDomainsData();
 ...
 */
HistoricalDomainsData.prototype['dimensions'] = undefined;
 ...
 */
HistoricalDomainsData.prototype['values'] = undefined;
...
export default HistoricalDomainsData;
