...
class MutualAuthentication {
    /**
     * Constructs a new <code>MutualAuthentication</code>.
    ...
    /**
     * Constructs a <code>MutualAuthentication</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MutualAuthentication} obj Optional instance to populate.
     * @return {module:model/MutualAuthentication} The populated <code>MutualAuthentication</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = MutualAuthenticationData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default MutualAuthentication;
