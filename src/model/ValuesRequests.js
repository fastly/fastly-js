...
class ValuesRequests {
    /**
     * Constructs a new <code>ValuesRequests</code>.
    ...
    /**
     * Constructs a <code>ValuesRequests</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValuesRequests} obj Optional instance to populate.
     * @return {module:model/ValuesRequests} The populated <code>ValuesRequests</code> instance.
     */
