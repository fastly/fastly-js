...
class TlsCsrDataAttributes {
     ...
     * @param sans {Array.<String>} Subject Altername Names - An array of one or more fully qualified domain names or public IP addresses to be secured by this certificate. Required.
     */
    constructor(sans) { 
