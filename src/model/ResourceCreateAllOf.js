...
class ResourceCreateAllOf {
    /**
     * Constructs a new <code>ResourceCreateAllOf</code>.
    ...
    /**
     * Constructs a <code>ResourceCreateAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResourceCreateAllOf} obj Optional instance to populate.
     * @return {module:model/ResourceCreateAllOf} The populated <code>ResourceCreateAllOf</code> instance.
     */
...
export default ResourceCreateAllOf;
