...
class StoreResponse {
    /**
     * Constructs a new <code>StoreResponse</code>.
    ...
    /**
     * Constructs a <code>StoreResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoreResponse} obj Optional instance to populate.
     * @return {module:model/StoreResponse} The populated <code>StoreResponse</code> instance.
     */
