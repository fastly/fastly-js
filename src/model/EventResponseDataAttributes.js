...
/**
 * The EventResponseDataAttributes model module.
 * @module model/EventResponseDataAttributes
 * @version 3.0.0-alpha1
 */
class EventResponseDataAttributes {
    /**
     * Constructs a new <code>EventResponseDataAttributes</code>.
     * @alias module:model/EventResponseDataAttributes
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>EventResponseDataAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EventResponseDataAttributes} obj Optional instance to populate.
     * @return {module:model/EventResponseDataAttributes} The populated <code>EventResponseDataAttributes</code> instance.
     */
 ...
 * @member {module:model/EventResponseDataAttributes.EventTypeEnum} event_type
 */
