...
class RelationshipMutualAuthenticationMutualAuthentication {
    /**
     * Constructs a new <code>RelationshipMutualAuthenticationMutualAuthentication</code>.
    ...
    /**
     * Constructs a <code>RelationshipMutualAuthenticationMutualAuthentication</code> from a plain JavaScript object, optionally creating a new instance.
     ...
     * @return {module:model/RelationshipMutualAuthenticationMutualAuthentication} The populated <code>RelationshipMutualAuthenticationMutualAuthentication</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = RelationshipMemberMutualAuthentication.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default RelationshipMutualAuthenticationMutualAuthentication;
