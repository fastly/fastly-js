...
import Mtdinvoice from './Mtdinvoice';
...
class MtdInvoiceResponse {
    /**
     * Constructs a new <code>MtdInvoiceResponse</code>.
     * @alias module:model/MtdInvoiceResponse
     * @implements module:model/Mtdinvoice
     */
    constructor() { 
        Mtdinvoice.initialize(this);
        MtdInvoiceResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MtdInvoiceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MtdInvoiceResponse} obj Optional instance to populate.
     * @return {module:model/MtdInvoiceResponse} The populated <code>MtdInvoiceResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MtdInvoiceResponse();
            Mtdinvoice.constructFromObject(data, obj);
 ...
 */
MtdInvoiceResponse.prototype['customer_id'] = undefined;

/**
 * An alphanumeric string identifying the invoice.
 * @member {String} invoice_id
 */
MtdInvoiceResponse.prototype['invoice_id'] = undefined;
 ...
 */
MtdInvoiceResponse.prototype['billing_start_date'] = undefined;
 ...
 */
MtdInvoiceResponse.prototype['billing_end_date'] = undefined;

/**
 * The total billable amount for invoiced services charged within a single month.
 * @member {String} monthly_transaction_amount
 */
MtdInvoiceResponse.prototype['monthly_transaction_amount'] = undefined;

/**
 * @member {Array.<module:model/Mtdlineitems>} transaction_line_items
 */
MtdInvoiceResponse.prototype['transaction_line_items'] = undefined;


// Implement Mtdinvoice interface:
/**
 * The Customer ID associated with the invoice.
 * @member {String} customer_id
 */
...
export default MtdInvoiceResponse;
