...
class LoggingNewrelicAdditional {
    /**
     * Constructs a new <code>LoggingNewrelicAdditional</code>.
    ...
    /**
     * Constructs a <code>LoggingNewrelicAdditional</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingNewrelicAdditional} obj Optional instance to populate.
     * @return {module:model/LoggingNewrelicAdditional} The populated <code>LoggingNewrelicAdditional</code> instance.
     */
