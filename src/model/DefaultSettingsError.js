...
class DefaultSettingsError {
    /**
     * Constructs a new <code>DefaultSettingsError</code>.
    ...
    /**
     * Constructs a <code>DefaultSettingsError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DefaultSettingsError} obj Optional instance to populate.
     * @return {module:model/DefaultSettingsError} The populated <code>DefaultSettingsError</code> instance.
     */
