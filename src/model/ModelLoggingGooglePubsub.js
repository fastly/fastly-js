...
import ModelLoggingGooglePubsubAllOf from './ModelLoggingGooglePubsubAllOf';
...
class ModelLoggingGooglePubsub {
    ...
    constructor() { 
        Timestamps.initialize(this);ServiceIdAndVersion.initialize(this);LoggingCommon.initialize(this);LoggingGcsCommon.initialize(this);ModelLoggingGooglePubsubAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ModelLoggingGooglePubsubAllOf.constructFromObject(data, obj);
...
ModelLoggingGooglePubsub.prototype['format_version'] = undefined;
...
// Implement ModelLoggingGooglePubsubAllOf interface:

ModelLoggingGooglePubsubAllOf.prototype['topic'] = undefined;

ModelLoggingGooglePubsubAllOf.prototype['format'] = '%h %l %u %t "%r" %&gt;s %b';

ModelLoggingGooglePubsubAllOf.prototype['project_id'] = undefined;
