...
class TlsCsrResponseAttributes {
    /**
     * Constructs a new <code>TlsCsrResponseAttributes</code>.
    ...
    /**
     * Constructs a <code>TlsCsrResponseAttributes</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TlsCsrResponseAttributes} obj Optional instance to populate.
     * @return {module:model/TlsCsrResponseAttributes} The populated <code>TlsCsrResponseAttributes</code> instance.
     */
...
export default TlsCsrResponseAttributes;
