...
class LogInsightsMeta {
    /**
     * Constructs a new <code>LogInsightsMeta</code>.
    ...
    /**
     * Constructs a <code>LogInsightsMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LogInsightsMeta} obj Optional instance to populate.
     * @return {module:model/LogInsightsMeta} The populated <code>LogInsightsMeta</code> instance.
     */
