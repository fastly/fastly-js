...
class ValuesCacheHitRatio {
    /**
     * Constructs a new <code>ValuesCacheHitRatio</code>.
    ...
    /**
     * Constructs a <code>ValuesCacheHitRatio</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValuesCacheHitRatio} obj Optional instance to populate.
     * @return {module:model/ValuesCacheHitRatio} The populated <code>ValuesCacheHitRatio</code> instance.
     */
