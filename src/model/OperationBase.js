...
/**
 * The OperationBase model module.
 * @module model/OperationBase
 * @version 15.0.0
 */
class OperationBase {
    /**
     * Constructs a new <code>OperationBase</code>.
     * @alias module:model/OperationBase
     */
    constructor() { 
    ...
    /**
     * Constructs a <code>OperationBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OperationBase} obj Optional instance to populate.
     * @return {module:model/OperationBase} The populated <code>OperationBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OperationBase();
