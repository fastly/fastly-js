...
class MutualAuthenticationResponse {
    /**
     * Constructs a new <code>MutualAuthenticationResponse</code>.
    ...
    /**
     * Constructs a <code>MutualAuthenticationResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MutualAuthenticationResponse} obj Optional instance to populate.
     * @return {module:model/MutualAuthenticationResponse} The populated <code>MutualAuthenticationResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = MutualAuthenticationResponseData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default MutualAuthenticationResponse;
