...
class DimensionStatusCode {
    /**
     * Constructs a new <code>DimensionStatusCode</code>.
    ...
    /**
     * Constructs a <code>DimensionStatusCode</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DimensionStatusCode} obj Optional instance to populate.
     * @return {module:model/DimensionStatusCode} The populated <code>DimensionStatusCode</code> instance.
     */
