...
import BotManagementResponseConfiguration from './BotManagementResponseConfiguration';
import BotManagementResponseConfigurationConfiguration from './BotManagementResponseConfigurationConfiguration';
...
class BotManagementResponseConfigure {
    /**
     * Constructs a new <code>BotManagementResponseConfigure</code>.
     * @alias module:model/BotManagementResponseConfigure
     * @implements module:model/BotManagementResponseProduct
     * @implements module:model/BotManagementResponseService
     * @implements module:model/BotManagementResponseConfiguration
     * @implements module:model/BotManagementResponseLinks
     */
    constructor() { 
        BotManagementResponseProduct.initialize(this);BotManagementResponseService.initialize(this);BotManagementResponseConfiguration.initialize(this);BotManagementResponseLinks.initialize(this);
        BotManagementResponseConfigure.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BotManagementResponseConfigure</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BotManagementResponseConfigure} obj Optional instance to populate.
     * @return {module:model/BotManagementResponseConfigure} The populated <code>BotManagementResponseConfigure</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BotManagementResponseConfigure();
            BotManagementResponseProduct.constructFromObject(data, obj);
            BotManagementResponseService.constructFromObject(data, obj);
            BotManagementResponseConfiguration.constructFromObject(data, obj);
            ...
            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = BotManagementResponseConfigurationConfiguration.constructFromObject(data['configuration']);
            }
 ...
 */
BotManagementResponseConfigure.prototype['product'] = undefined;

/**
 * @member {module:model/ApiDiscoveryResponseServiceService} service
 */
BotManagementResponseConfigure.prototype['service'] = undefined;

/**
 * @member {module:model/BotManagementResponseConfigurationConfiguration} configuration
 */
BotManagementResponseConfigure.prototype['configuration'] = undefined;

/**
 * @member {module:model/BotManagementResponseLinksLinks} _links
 */
BotManagementResponseConfigure.prototype['_links'] = undefined;
...
// Implement BotManagementResponseConfiguration interface:
/**
 * @member {module:model/BotManagementResponseConfigurationConfiguration} configuration
 */
BotManagementResponseConfiguration.prototype['configuration'] = undefined;
...
export default BotManagementResponseConfigure;
