...
class LoggingHerokuAdditional {
    /**
     * Constructs a new <code>LoggingHerokuAdditional</code>.
    ...
    /**
     * Constructs a <code>LoggingHerokuAdditional</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LoggingHerokuAdditional} obj Optional instance to populate.
     * @return {module:model/LoggingHerokuAdditional} The populated <code>LoggingHerokuAdditional</code> instance.
     */
