...
class ValuesMisses {
    /**
     * Constructs a new <code>ValuesMisses</code>.
    ...
    /**
     * Constructs a <code>ValuesMisses</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValuesMisses} obj Optional instance to populate.
     * @return {module:model/ValuesMisses} The populated <code>ValuesMisses</code> instance.
     */
