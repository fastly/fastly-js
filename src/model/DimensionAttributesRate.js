...
class DimensionAttributesRate {
    /**
     * Constructs a new <code>DimensionAttributesRate</code>.
    ...
    /**
     * Constructs a <code>DimensionAttributesRate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DimensionAttributesRate} obj Optional instance to populate.
     * @return {module:model/DimensionAttributesRate} The populated <code>DimensionAttributesRate</code> instance.
     */
