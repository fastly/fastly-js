...
/**
* LoggingEndpointErrors service.
* @module api/LoggingEndpointErrorsApi
* @version 16.1.0
*/
export default class LoggingEndpointErrorsApi {

    /**
    * Constructs a new LoggingEndpointErrorsApi. 
    * @alias module:api/LoggingEndpointErrorsApi
    * @class
    ...
    */
     ...
     * @param {String} [options.filter_endpoint]
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link String} and HTTP response
     */
    getLogEndpointErrorsWithHttpInfo(options = {}) {
      let postBody = null;
      ...
      let queryParams = {
        'from': options['from'],
        'to': options['to'],
        'filter[endpoint]': options['filter_endpoint']
      };
      let headerParams = {
      };
      let formParams = {
      ...
      return this.apiClient.callApi(
        '/observability/service/{service_id}/logging/errors', 'GET',
     ...
     */
    getLogEndpointErrors(options = {}) {
      return this.getLogEndpointErrorsWithHttpInfo(options)
