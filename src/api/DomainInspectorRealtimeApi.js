...
export default class DomainInspectorRealtimeApi {
    ...
    /**
    * Constructs a new DomainInspectorRealtimeApi. 
    * @alias module:api/DomainInspectorRealtimeApi
    * @class
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DomainInspector} and HTTP response
     */
    getDomainInspectorLast120SecondsWithHttpInfo(options = {}) {
      let postBody = null;
      ...
      let returnType = DomainInspector;
      ...
      return this.apiClient.callApi(
        '/v1/domains/{service_id}/ts/h', 'GET',
     ...
     * @param {Object} options
     * @param {String} options.service_id - Alphanumeric string identifying the service.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DomainInspector}
     */
    getDomainInspectorLast120Seconds(options = {}) {
      return this.getDomainInspectorLast120SecondsWithHttpInfo(options)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DomainInspector} and HTTP response
     */
    getDomainInspectorLastMaxEntriesWithHttpInfo(options = {}) {
      let postBody = null;
      // Verify the required parameter 'service_id' is set.
      if (options['service_id'] === undefined || options['service_id'] === null) {
        throw new Error("Missing the required parameter 'service_id'.");
      ...
      return this.apiClient.callApi(
        '/v1/domains/{service_id}/ts/h/limit/{max_entries}', 'GET',
        pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DomainInspector}
     */
    getDomainInspectorLastMaxEntries(options = {}) {
      return this.getDomainInspectorLastMaxEntriesWithHttpInfo(options)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/DomainInspector} and HTTP response
     */
    getDomainInspectorLastSecondWithHttpInfo(options = {}) {
      let postBody = null;
      // Verify the required parameter 'service_id' is set.
      if (options['service_id'] === undefined || options['service_id'] === null) {
        throw new Error("Missing the required parameter 'service_id'.");
      ...
      return this.apiClient.callApi(
        '/v1/domains/{service_id}/ts/{start_timestamp}', 'GET',
        pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/DomainInspector}
     */
    getDomainInspectorLastSecond(options = {}) {
      return this.getDomainInspectorLastSecondWithHttpInfo(options)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
