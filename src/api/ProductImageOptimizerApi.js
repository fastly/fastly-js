...
export default class ProductImageOptimizerApi {
    ...
    /**
    * Constructs a new ProductImageOptimizerApi. 
    * @alias module:api/ProductImageOptimizerApi
    * @class
    ...
    */
     ...
     */
    disableProductImageOptimizerWithHttpInfo(options = {}) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/enabled-products/v1/image_optimizer/services/{service_id}', 'DELETE',
     ...
     */
    disableProductImageOptimizer(options = {}) {
      return this.disableProductImageOptimizerWithHttpInfo(options)
     ...
     * @param {Object} options
     * @param {String} options.service_id - Alphanumeric string identifying the service.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageOptimizerResponseBodyEnable} and HTTP response
     */
    enableProductImageOptimizerWithHttpInfo(options = {}) {
      let postBody = null;
      // Verify the required parameter 'service_id' is set.
      if (options['service_id'] === undefined || options['service_id'] === null) {
        throw new Error("Missing the required parameter 'service_id'.");
      ...
      let returnType = ImageOptimizerResponseBodyEnable;
      let basePaths = ['https://api.fastly.com'];
      let basePath = basePaths[0]; // by default use the first one in "servers" defined in OpenAPI
      if (typeof options['_base_path_index'] !== 'undefined') {
        if (options['_base_path_index']  >= basePaths.length || options['_base_path_index'] <  0) {
      ...
      return this.apiClient.callApi(
        '/enabled-products/v1/image_optimizer/services/{service_id}', 'PUT',
        pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath
      );
    }
     ...
     * @param {Object} options
     * @param {String} options.service_id - Alphanumeric string identifying the service.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ImageOptimizerResponseBodyEnable}
     */
    enableProductImageOptimizer(options = {}) {
      return this.enableProductImageOptimizerWithHttpInfo(options)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageOptimizerResponseBodyEnable} and HTTP response
     */
    getProductImageOptimizerWithHttpInfo(options = {}) {
      let postBody = null;
      // Verify the required parameter 'service_id' is set.
      if (options['service_id'] === undefined || options['service_id'] === null) {
        throw new Error("Missing the required parameter 'service_id'.");
      ...
      return this.apiClient.callApi(
        '/enabled-products/v1/image_optimizer/services/{service_id}', 'GET',
        pathParams, pathParamsAllowReserved, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, basePath
      );
    }
