...
export default class BackendApi {
    ...
    createBackendWithHttpInfo(service_id, version_id, opts) {
      ...
      if (service_id === undefined || service_id === null) {
        throw new Error("Missing the required parameter 'service_id' when calling createBackend");
      }
      // verify the required parameter 'version_id' is set
      if (version_id === undefined || version_id === null) {
        throw new Error("Missing the required parameter 'version_id' when calling createBackend");
      }
    ...
    deleteBackendWithHttpInfo(service_id, version_id, backend_name) {
      let postBody = null;
      // verify the required parameter 'service_id' is set
      if (service_id === undefined || service_id === null) {
        throw new Error("Missing the required parameter 'service_id' when calling deleteBackend");
      }
      // verify the required parameter 'version_id' is set
      if (version_id === undefined || version_id === null) {
        throw new Error("Missing the required parameter 'version_id' when calling deleteBackend");
      }
      // verify the required parameter 'backend_name' is set
      if (backend_name === undefined || backend_name === null) {
        throw new Error("Missing the required parameter 'backend_name' when calling deleteBackend");
      }
    ...
    deleteBackend(service_id, version_id, backend_name) {
      return this.deleteBackendWithHttpInfo(service_id, version_id, backend_name)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    getBackendWithHttpInfo(service_id, version_id, backend_name) {
      let postBody = null;
      // verify the required parameter 'service_id' is set
      if (service_id === undefined || service_id === null) {
        throw new Error("Missing the required parameter 'service_id' when calling getBackend");
      }
      // verify the required parameter 'version_id' is set
      if (version_id === undefined || version_id === null) {
        throw new Error("Missing the required parameter 'version_id' when calling getBackend");
      }
      // verify the required parameter 'backend_name' is set
      if (backend_name === undefined || backend_name === null) {
        throw new Error("Missing the required parameter 'backend_name' when calling getBackend");
      }
    ...
    getBackend(service_id, version_id, backend_name) {
      return this.getBackendWithHttpInfo(service_id, version_id, backend_name)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    listBackendsWithHttpInfo(service_id, version_id) {
      let postBody = null;
      // verify the required parameter 'service_id' is set
      if (service_id === undefined || service_id === null) {
        throw new Error("Missing the required parameter 'service_id' when calling listBackends");
      }
      // verify the required parameter 'version_id' is set
      if (version_id === undefined || version_id === null) {
        throw new Error("Missing the required parameter 'version_id' when calling listBackends");
      }
    ...
    listBackends(service_id, version_id) {
      return this.listBackendsWithHttpInfo(service_id, version_id)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    updateBackendWithHttpInfo(service_id, version_id, backend_name, opts) {
      ...
      // verify the required parameter 'service_id' is set
      if (service_id === undefined || service_id === null) {
        throw new Error("Missing the required parameter 'service_id' when calling updateBackend");
      }
      // verify the required parameter 'version_id' is set
      if (version_id === undefined || version_id === null) {
        throw new Error("Missing the required parameter 'version_id' when calling updateBackend");
      }
      // verify the required parameter 'backend_name' is set
      if (backend_name === undefined || backend_name === null) {
        throw new Error("Missing the required parameter 'backend_name' when calling updateBackend");
      }
