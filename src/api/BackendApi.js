...
export default class BackendApi {
    ...
    */
     ...
     * @param {Boolean} [options.prefer_ipv6] - Prefer IPv6 connections to origins for hostname backends. Default is 'false' for Delivery services and 'true' for Compute services.
     ...
     * @param {String} [options.shield] - Identifier of the POP to use as a [shield](https://www.fastly.com/documentation/guides/getting-started/hosts/shielding/).
