...
export default class LoggingDatadogApi {
    ...
    createLogDatadogWithHttpInfo(service_id, version_id, opts) {
      ...
      let returnType = ModelLoggingDatadog;
    ...
    updateLogDatadogWithHttpInfo(service_id, version_id, logging_datadog_name) {
      let postBody = null;
      // verify the required parameter 'service_id' is set
      if (service_id === undefined || service_id === null) {
    ...
    updateLogDatadog(service_id, version_id, logging_datadog_name) {
      return this.updateLogDatadogWithHttpInfo(service_id, version_id, logging_datadog_name)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
