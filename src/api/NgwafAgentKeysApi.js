...
export default class NgwafAgentKeysApi {
    ...
    /**
    * Constructs a new NgwafAgentKeysApi. 
    * @alias module:api/NgwafAgentKeysApi
    * @class
    ...
    */
     ...
     */
    ngwafListAgentKeysWithHttpInfo(options = {}) {
      let postBody = null;
      ...
      return this.apiClient.callApi(
        '/ngwaf/v1/workspaces/{workspace_id}/agent-keys', 'GET',
     ...
     */
    ngwafListAgentKeys(options = {}) {
      return this.ngwafListAgentKeysWithHttpInfo(options)
