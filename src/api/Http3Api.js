...
export default class Http3Api {
    ...
    */
     ...
     */
    createHttp3WithHttpInfo(options = {}) {
      let postBody = null;
     ...
     */
    createHttp3(options = {}) {
      return this.createHttp3WithHttpInfo(options)
     ...
     */
    deleteHttp3WithHttpInfo(options = {}) {
      let postBody = null;
      // Verify the required parameter 'service_id' is set.
      if (options['service_id'] === undefined || options['service_id'] === null) {
        throw new Error("Missing the required parameter 'service_id'.");
     ...
     */
    deleteHttp3(options = {}) {
      return this.deleteHttp3WithHttpInfo(options)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     */
    getHttp3(options = {}) {
      return this.getHttp3WithHttpInfo(options)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
