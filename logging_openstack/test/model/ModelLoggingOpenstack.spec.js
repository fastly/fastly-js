...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStack.ModelLoggingOpenstack();
  });
  ...
  describe('ModelLoggingOpenstack', function() {
    it('should create an instance of ModelLoggingOpenstack', function() {
      // uncomment below and update the code to test ModelLoggingOpenstack
      //var instane = new OpenStack.ModelLoggingOpenstack();
      //expect(instance).to.be.a(OpenStack.ModelLoggingOpenstack);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new OpenStack.ModelLoggingOpenstack();
