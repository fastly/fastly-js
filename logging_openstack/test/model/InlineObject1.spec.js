...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenStack.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new OpenStack.InlineObject1();
      //expect(instance).to.be.a(OpenStack.InlineObject1);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new OpenStack.InlineObject1();
