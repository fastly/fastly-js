...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Customer.ModelCustomer();
  });
  ...
  describe('ModelCustomer', function() {
    it('should create an instance of ModelCustomer', function() {
      // uncomment below and update the code to test ModelCustomer
      //var instane = new Customer.ModelCustomer();
      //expect(instance).to.be.a(Customer.ModelCustomer);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Customer.ModelCustomer();
