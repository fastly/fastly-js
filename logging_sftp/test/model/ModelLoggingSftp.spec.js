...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Sftp.ModelLoggingSftp();
  });
  ...
  describe('ModelLoggingSftp', function() {
    it('should create an instance of ModelLoggingSftp', function() {
      // uncomment below and update the code to test ModelLoggingSftp
      //var instane = new Sftp.ModelLoggingSftp();
      //expect(instance).to.be.a(Sftp.ModelLoggingSftp);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Sftp.ModelLoggingSftp();
