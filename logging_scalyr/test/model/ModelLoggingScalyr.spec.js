...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Scalyr.ModelLoggingScalyr();
  });
  ...
  describe('ModelLoggingScalyr', function() {
    it('should create an instance of ModelLoggingScalyr', function() {
      // uncomment below and update the code to test ModelLoggingScalyr
      //var instane = new Scalyr.ModelLoggingScalyr();
      //expect(instance).to.be.a(Scalyr.ModelLoggingScalyr);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Scalyr.ModelLoggingScalyr();
