...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Syslog.ModelLoggingSyslog();
  });
  ...
  describe('ModelLoggingSyslog', function() {
    it('should create an instance of ModelLoggingSyslog', function() {
      // uncomment below and update the code to test ModelLoggingSyslog
      //var instane = new Syslog.ModelLoggingSyslog();
      //expect(instance).to.be.a(Syslog.ModelLoggingSyslog);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Syslog.ModelLoggingSyslog();
