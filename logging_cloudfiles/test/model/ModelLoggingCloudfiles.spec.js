...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CloudFiles.ModelLoggingCloudfiles();
  });
  ...
  describe('ModelLoggingCloudfiles', function() {
    it('should create an instance of ModelLoggingCloudfiles', function() {
      // uncomment below and update the code to test ModelLoggingCloudfiles
      //var instane = new CloudFiles.ModelLoggingCloudfiles();
      //expect(instance).to.be.a(CloudFiles.ModelLoggingCloudfiles);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new CloudFiles.ModelLoggingCloudfiles();
