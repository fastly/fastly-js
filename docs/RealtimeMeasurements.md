...
**object_store_read_requests** | **Number** | The total number of reads received for the object store. | [optional] 
**object_store_write_requests** | **Number** | The total number of writes received for the object store. | [optional] 
