...
```javascript
createLogDigocean({ service_id, version_id, [name, ][placement, ][response_condition, ][format, ][log_processing_region, ][format_version, ][message_type, ][timestamp_format, ][compression_codec, ][period, ][gzip_level, ][bucket_name, ][access_key, ][secret_key, ][domain, ][path, ][public_key] })
```
...
```javascript
updateLogDigocean({ service_id, version_id, logging_digitalocean_name, [name, ][placement, ][response_condition, ][format, ][log_processing_region, ][format_version, ][message_type, ][timestamp_format, ][compression_codec, ][period, ][gzip_level, ][bucket_name, ][access_key, ][secret_key, ][domain, ][path, ][public_key] })
```
