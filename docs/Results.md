...
**bandwidth** | **Number** | Total bytes delivered (&#x60;resp_header_bytes&#x60; + &#x60;resp_body_bytes&#x60; + &#x60;bereq_header_bytes&#x60; + &#x60;bereq_body_bytes&#x60; + &#x60;compute_resp_header_bytes&#x60; + &#x60;compute_resp_body_bytes&#x60; + &#x60;compute_bereq_header_bytes&#x60; + &#x60;compute_bereq_body_bytes&#x60;). | [optional] 
...
**compute_bereq_body_bytes** | **Number** | Total body bytes sent to backends (origins) by Compute@Edge. | [optional] 
**compute_bereq_errors** | **Number** | Number of backend request errors, including timeouts. | [optional] 
**compute_bereq_header_bytes** | **Number** | Total header bytes sent to backends (origins) by Compute@Edge. | [optional] 
**compute_bereqs** | **Number** | Number of backend requests started. | [optional] 
**compute_beresp_body_bytes** | **Number** | Total body bytes received from backends (origins) by Compute@Edge. | [optional] 
**compute_beresp_header_bytes** | **Number** | Total header bytes received from backends (origins) by Compute@Edge. | [optional] 
...
**compute_ram_used** | **Number** | The amount of RAM used for your site by Fastly, including a maximum indicating the highest usage within this timeframe and a static cap for usage. | [optional] 
**compute_req_body_bytes** | **Number** | Total body bytes received by Compute@Edge. | [optional] 
**compute_req_header_bytes** | **Number** | Total header bytes received by Compute@Edge. | [optional] 
...
**compute_requests** | **Number** | The total number of requests that were received for your site by Fastly. | [optional] 
...
**compute_resp_body_bytes** | **Number** | Total body bytes sent from Compute@Edge to end user. | [optional] 
**compute_resp_header_bytes** | **Number** | Total header bytes sent from Compute@Edge to end user. | [optional] 
**compute_resp_status_1xx** | **Number** | Number of \&quot;Informational\&quot; category status codes delivered by Compute@Edge. | [optional] 
**compute_resp_status_2xx** | **Number** | Number of \&quot;Success\&quot; category status codes delivered by Compute@Edge. | [optional] 
**compute_resp_status_3xx** | **Number** | Number of \&quot;Redirection\&quot; category status codes delivered by Compute@Edge. | [optional] 
**compute_resp_status_4xx** | **Number** | Number of \&quot;Client Error\&quot; category status codes delivered by Compute@Edge. | [optional] 
**compute_resp_status_5xx** | **Number** | Number of \&quot;Server Error\&quot; category status codes delivered by Compute@Edge. | [optional] 
...
**imgopto** | **Number** | Number of responses that came from the Fastly Image Optimizer service. | [optional] 
**imgopto_resp_body_bytes** | **Number** | Total body bytes delivered from the Fastly Image Optimizer service. | [optional] 
**imgopto_resp_header_bytes** | **Number** | Total header bytes delivered from the Fastly Image Optimizer service. | [optional] 
