...
```javascript
createLogBigquery({ service_id, version_id, [name, ][placement, ][format_version, ][response_condition, ][format, ][user, ][secret_key, ][account_name, ][dataset, ][table, ][template_suffix, ][project_id] })
```
...
```javascript
updateLogBigquery({ service_id, version_id, logging_bigquery_name, [name, ][placement, ][format_version, ][response_condition, ][format, ][user, ][secret_key, ][account_name, ][dataset, ][table, ][template_suffix, ][project_id] })
```
