...
```javascript
createLogDatadog({ service_id, version_id, [name, ][placement, ][response_condition, ][format, ][log_processing_region, ][format_version, ][region, ][token] })
```
...
```javascript
updateLogDatadog({ service_id, version_id, logging_datadog_name, [name, ][placement, ][response_condition, ][format, ][log_processing_region, ][format_version, ][region, ][token] })
```
