...
```javascript
createLogOpenstack({ service_id, version_id, [name, ][placement, ][response_condition, ][format, ][format_version, ][message_type, ][timestamp_format, ][compression_codec, ][period, ][gzip_level, ][access_key, ][bucket_name, ][path, ][public_key, ][url, ][user] })
```
...
```javascript
updateLogOpenstack({ service_id, version_id, logging_openstack_name, [name, ][placement, ][response_condition, ][format, ][format_version, ][message_type, ][timestamp_format, ][compression_codec, ][period, ][gzip_level, ][access_key, ][bucket_name, ][path, ][public_key, ][url, ][user] })
```
