...
> ModelLoggingLoggly createLogLoggly(service_id, version_id, opts)
...
[**ModelLoggingLoggly**](ModelLoggingLoggly.md)
...
> ModelLoggingLoggly getLogLoggly(service_id, version_id, logging_loggly_name)
...
> [ModelLoggingLoggly] listLogLoggly(service_id, version_id)
...
> ModelLoggingLoggly updateLogLoggly(service_id, version_id, logging_loggly_name, opts)
