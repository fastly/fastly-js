...
```javascript
createLogAzure({ service_id, version_id, [name, ][placement, ][response_condition, ][format, ][format_version, ][message_type, ][timestamp_format, ][compression_codec, ][period, ][gzip_level, ][path, ][account_name, ][container, ][sas_token, ][public_key, ][file_max_bytes] })
```
...
```javascript
updateLogAzure({ service_id, version_id, logging_azureblob_name, [name, ][placement, ][response_condition, ][format, ][format_version, ][message_type, ][timestamp_format, ][compression_codec, ][period, ][gzip_level, ][path, ][account_name, ][container, ][sas_token, ][public_key, ][file_max_bytes] })
```
