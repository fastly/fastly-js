...
(function(root, factory) {
  ...
  describe('ModelPool', function() {
    it('should create an instance of ModelPool', function() {
      // uncomment below and update the code to test ModelPool
      //var instane = new Pool.ModelPool();
      //expect(instance).to.be.a(Pool.ModelPool);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Pool.ModelPool();
