...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RealTimeAnalytics.ModelMeasurements();
  });
  ...
  describe('ModelMeasurements', function() {
    it('should create an instance of ModelMeasurements', function() {
      ...
      //var instane = new RealTimeAnalytics.ModelMeasurements();
      //expect(instance).to.be.a(RealTimeAnalytics.ModelMeasurements);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new RealTimeAnalytics.ModelMeasurements();
