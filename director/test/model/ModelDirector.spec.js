...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Director.ModelDirector();
  });
  ...
  describe('ModelDirector', function() {
    it('should create an instance of ModelDirector', function() {
      // uncomment below and update the code to test ModelDirector
      //var instane = new Director.ModelDirector();
      //expect(instance).to.be.a(Director.ModelDirector);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Director.ModelDirector();
