# Logentries.LoggingLogentriesApi
...
> InlineObject createLogLogentries(serviceId, versionId, opts)
...
let defaultClient = Logentries.ApiClient.instance;
...
let apiInstance = new Logentries.LoggingLogentriesApi();
...
apiInstance.createLogLogentries(serviceId, versionId, opts).then((data) => {
...
> Object deleteLogLogentries(serviceId, versionId, loggingLogentriesName)
...
let serviceId = SU1Z0isxPaozGVKXdv0eY; // String | 
let versionId = 1; // Number | 
let loggingLogentriesName = log-endpoint-name; // String | 
apiInstance.deleteLogLogentries(serviceId, versionId, loggingLogentriesName).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> InlineObject getLogLogentries(serviceId, versionId, loggingLogentriesName)
...
let versionId = 1; // Number | 
let loggingLogentriesName = log-endpoint-name; // String | 
apiInstance.getLogLogentries(serviceId, versionId, loggingLogentriesName).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> [InlineResponse200] listLogLogentries(serviceId, versionId)
...
let serviceId = SU1Z0isxPaozGVKXdv0eY; // String | 
let versionId = 1; // Number | 
apiInstance.listLogLogentries(serviceId, versionId).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> InlineObject1 updateLogLogentries(serviceId, versionId, loggingLogentriesName, opts)
...
apiInstance.updateLogLogentries(serviceId, versionId, loggingLogentriesName, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
