...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Logentries.ModelLoggingLogentries();
  });
  ...
  describe('ModelLoggingLogentries', function() {
    it('should create an instance of ModelLoggingLogentries', function() {
      // uncomment below and update the code to test ModelLoggingLogentries
      //var instane = new Logentries.ModelLoggingLogentries();
      //expect(instance).to.be.a(Logentries.ModelLoggingLogentries);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Logentries.ModelLoggingLogentries();
