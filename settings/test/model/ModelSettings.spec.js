...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Settings.ModelSettings();
  });
  ...
  describe('ModelSettings', function() {
    it('should create an instance of ModelSettings', function() {
      ...
      //var instane = new Settings.ModelSettings();
      //expect(instance).to.be.a(Settings.ModelSettings);
    });

    it('should have the property serviceId (base name: "service_id")', function() {
      // uncomment below and update the code to test the property serviceId
      //var instance = new Settings.ModelSettings();
