...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kafka.ModelLoggingKafka();
  });
  ...
  describe('ModelLoggingKafka', function() {
    it('should create an instance of ModelLoggingKafka', function() {
      // uncomment below and update the code to test ModelLoggingKafka
      //var instane = new Kafka.ModelLoggingKafka();
      //expect(instance).to.be.a(Kafka.ModelLoggingKafka);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Kafka.ModelLoggingKafka();
