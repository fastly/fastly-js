...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Https.ModelLoggingHttps();
  });
  ...
  describe('ModelLoggingHttps', function() {
    it('should create an instance of ModelLoggingHttps', function() {
      // uncomment below and update the code to test ModelLoggingHttps
      //var instane = new Https.ModelLoggingHttps();
      //expect(instance).to.be.a(Https.ModelLoggingHttps);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Https.ModelLoggingHttps();
