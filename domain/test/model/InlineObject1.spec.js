...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Domain.InlineObject1();
  });
  ...
  describe('InlineObject1', function() {
    it('should create an instance of InlineObject1', function() {
      ...
      //var instane = new Domain.InlineObject1();
      //expect(instance).to.be.a(Domain.InlineObject1);
    });

    it('should have the property serviceId (base name: "service_id")', function() {
      // uncomment below and update the code to test the property serviceId
      //var instance = new Domain.InlineObject1();
