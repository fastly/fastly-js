...
> InlineObject createLogHeroku(serviceId, versionId, opts)
...
let defaultClient = Heroku.ApiClient.instance;
...
let apiInstance = new Heroku.LoggingHerokuApi();
...
apiInstance.createLogHeroku(serviceId, versionId, opts).then((data) => {
...
> Object deleteLogHeroku(serviceId, versionId, loggingHerokuName)
...
let serviceId = SU1Z0isxPaozGVKXdv0eY; // String | 
let versionId = 1; // Number | 
let loggingHerokuName = log-endpoint-name; // String | 
apiInstance.deleteLogHeroku(serviceId, versionId, loggingHerokuName).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> InlineObject getLogHeroku(serviceId, versionId, loggingHerokuName)
...
let versionId = 1; // Number | 
let loggingHerokuName = log-endpoint-name; // String | 
apiInstance.getLogHeroku(serviceId, versionId, loggingHerokuName).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> [InlineResponse200] listLogHeroku(serviceId, versionId)
...
let serviceId = SU1Z0isxPaozGVKXdv0eY; // String | 
let versionId = 1; // Number | 
apiInstance.listLogHeroku(serviceId, versionId).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> InlineObject1 updateLogHeroku(serviceId, versionId, loggingHerokuName, opts)
...
apiInstance.updateLogHeroku(serviceId, versionId, loggingHerokuName, opts).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
