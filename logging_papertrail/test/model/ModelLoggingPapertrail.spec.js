...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Papertrail.ModelLoggingPapertrail();
  });
  ...
  describe('ModelLoggingPapertrail', function() {
    it('should create an instance of ModelLoggingPapertrail', function() {
      // uncomment below and update the code to test ModelLoggingPapertrail
      //var instane = new Papertrail.ModelLoggingPapertrail();
      //expect(instance).to.be.a(Papertrail.ModelLoggingPapertrail);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Papertrail.ModelLoggingPapertrail();
