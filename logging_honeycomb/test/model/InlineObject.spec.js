...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HoneycombLogging.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new HoneycombLogging.InlineObject();
      //expect(instance).to.be.a(HoneycombLogging.InlineObject);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new HoneycombLogging.InlineObject();
