...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Elasticsearch.ModelLoggingElasticsearch();
  });
  ...
  describe('ModelLoggingElasticsearch', function() {
    it('should create an instance of ModelLoggingElasticsearch', function() {
      // uncomment below and update the code to test ModelLoggingElasticsearch
      //var instane = new Elasticsearch.ModelLoggingElasticsearch();
      //expect(instance).to.be.a(Elasticsearch.ModelLoggingElasticsearch);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new Elasticsearch.ModelLoggingElasticsearch();
