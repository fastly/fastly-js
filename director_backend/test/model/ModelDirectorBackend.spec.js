...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DirectorBackend.ModelDirectorBackend();
  });
  ...
  describe('ModelDirectorBackend', function() {
    it('should create an instance of ModelDirectorBackend', function() {
      // uncomment below and update the code to test ModelDirectorBackend
      //var instane = new DirectorBackend.ModelDirectorBackend();
      //expect(instance).to.be.a(DirectorBackend.ModelDirectorBackend);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new DirectorBackend.ModelDirectorBackend();
