...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanSpaces.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instane = new DigitalOceanSpaces.InlineResponse200();
      //expect(instance).to.be.a(DigitalOceanSpaces.InlineResponse200);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new DigitalOceanSpaces.InlineResponse200();
