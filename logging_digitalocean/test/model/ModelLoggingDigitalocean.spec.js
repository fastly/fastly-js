...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DigitalOceanSpaces.ModelLoggingDigitalocean();
  });
  ...
  describe('ModelLoggingDigitalocean', function() {
    it('should create an instance of ModelLoggingDigitalocean', function() {
      // uncomment below and update the code to test ModelLoggingDigitalocean
      //var instane = new DigitalOceanSpaces.ModelLoggingDigitalocean();
      //expect(instance).to.be.a(DigitalOceanSpaces.ModelLoggingDigitalocean);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new DigitalOceanSpaces.ModelLoggingDigitalocean();
