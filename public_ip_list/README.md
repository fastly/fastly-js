...
PublicIpList - JavaScript client for public_ip_list
...
```shell
npm install public_ip_list --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your public_ip_list from, and run:
...
```javascript
var PublicIpList = require('public_ip_list');


var api = new PublicIpList.UtilsPublicIpListApi()
api.listFastlyIps().then(function() {
...
------------ | ------------- | ------------- | -------------
*PublicIpList.UtilsPublicIpListApi* | [**listFastlyIps**](docs/UtilsPublicIpListApi.md#listFastlyIps) | **GET** /public-ip-list | List Fastly&#39;s public IPs
