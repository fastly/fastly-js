...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VclSnippets.ModelSnippet();
  });
  ...
  describe('ModelSnippet', function() {
    it('should create an instance of ModelSnippet', function() {
      // uncomment below and update the code to test ModelSnippet
      //var instane = new VclSnippets.ModelSnippet();
      //expect(instance).to.be.a(VclSnippets.ModelSnippet);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new VclSnippets.ModelSnippet();
