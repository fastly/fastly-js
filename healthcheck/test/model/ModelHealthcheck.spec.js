...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Healthcheck.ModelHealthcheck();
  });
  ...
  describe('ModelHealthcheck', function() {
    it('should create an instance of ModelHealthcheck', function() {
      // uncomment below and update the code to test ModelHealthcheck
      //var instane = new Healthcheck.ModelHealthcheck();
      //expect(instance).to.be.a(Healthcheck.ModelHealthcheck);
    });

    it('should have the property serviceId (base name: "service_id")', function() {
      // uncomment below and update the code to test the property serviceId
      //var instance = new Healthcheck.ModelHealthcheck();
