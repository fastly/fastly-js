...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LogShuttle.ModelLoggingLogshuttle();
  });
  ...
  describe('ModelLoggingLogshuttle', function() {
    it('should create an instance of ModelLoggingLogshuttle', function() {
      // uncomment below and update the code to test ModelLoggingLogshuttle
      //var instane = new LogShuttle.ModelLoggingLogshuttle();
      //expect(instance).to.be.a(LogShuttle.ModelLoggingLogshuttle);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new LogShuttle.ModelLoggingLogshuttle();
