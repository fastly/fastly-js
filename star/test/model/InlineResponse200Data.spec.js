...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Star.InlineResponse200Data();
  });
  ...
  describe('InlineResponse200Data', function() {
    it('should create an instance of InlineResponse200Data', function() {
      ...
      //var instane = new Star.InlineResponse200Data();
      //expect(instance).to.be.a(Star.InlineResponse200Data);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new Star.InlineResponse200Data();
