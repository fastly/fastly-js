...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GcsLogging.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new GcsLogging.InlineObject();
      //expect(instance).to.be.a(GcsLogging.InlineObject);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new GcsLogging.InlineObject();
