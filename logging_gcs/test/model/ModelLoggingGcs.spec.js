...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GcsLogging.ModelLoggingGcs();
  });
  ...
  describe('ModelLoggingGcs', function() {
    it('should create an instance of ModelLoggingGcs', function() {
      // uncomment below and update the code to test ModelLoggingGcs
      //var instane = new GcsLogging.ModelLoggingGcs();
      //expect(instance).to.be.a(GcsLogging.ModelLoggingGcs);
    });

    it('should have the property createdAt (base name: "created_at")', function() {
      // uncomment below and update the code to test the property createdAt
      //var instance = new GcsLogging.ModelLoggingGcs();
